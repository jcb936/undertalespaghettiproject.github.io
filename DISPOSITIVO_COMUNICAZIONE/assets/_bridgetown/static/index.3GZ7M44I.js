// Downloaded from https://deltarune.com/_bridgetown/static/index.3GZ7M44I.js on 16/06/2026. All rights resereved, code belonging
...
(() => {
  ...
  var Co = (o, t, e) => (t in o ? Pt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (o[t] = e));
  var xt = ((o) =>
    typeof require < "u"
      ? require
      : typeof Proxy < "u"
  ...
  var ni = (o, t) => () => (t || o((t = { exports: {} }).exports, t), t.exports),
    R = (o, t) => {
      for (var e in t) Pt(o, e, { get: t[e], enumerable: !0 });
    },
    xo = (o, t, e, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let i of Uo(t))
          !Io.call(o, i) && i !== e && Pt(o, i, { get: () => t[i], enumerable: !(n = vo(t, i)) || n.enumerable });
      return o;
    };
  var $t = (o, t, e) => (
    (e = o != null ? Fo(yo(o)) : {}),
    xo(t || !o || !o.__esModule ? Pt(e, "default", { value: o, enumerable: !0 }) : e, o)
  );
  var W = (o, t, e) => (Co(o, typeof t != "symbol" ? t + "" : t, e), e);
  var Ge = ni((Oe) => {
    (function () {
      "use strict";
      var o = function () {
      ...
      o.prototype = {
        ...
        volume: function (s) {
          var r = this || t;
          if (((s = parseFloat(s)), r.ctx || g(), typeof s < "u" && s >= 0 && s <= 1)) {
            ...
            for (var d = 0; d < r._howls.length; d++)
              if (!r._howls[d]._webAudio)
                for (var h = r._howls[d]._getSoundIds(), b = 0; b < h.length; b++) {
                  var m = r._howls[d]._soundById(h[b]);
                  m && m._node && (m._node.volume = m._volume * s);
                }
            return r;
          }
          return r._volume;
        ...
        mute: function (s) {
          ...
          for (var d = 0; d < r._howls.length; d++)
            if (!r._howls[d]._webAudio)
              for (var h = r._howls[d]._getSoundIds(), b = 0; b < h.length; b++) {
                var m = r._howls[d]._soundById(h[b]);
                m && m._node && (m._node.muted = s ? !0 : m._muted);
              }
          return r;
        },
        stop: function () {
        ...
        unload: function () {
          ...
          return (s.usingWebAudio && s.ctx && typeof s.ctx.close < "u" && (s.ctx.close(), (s.ctx = null), g()), s);
        },
        codecs: function (s) {
        ...
        _setupCodecs: function () {
          ...
          var d = r.canPlayType("audio/mpeg;").replace(/^no$/, ""),
            ...
            b = h.match(/OPR\/(\d+)/g),
            m = b && parseInt(b[0].split("/")[1], 10) < 33,
            p = h.indexOf("Safari") !== -1 && h.indexOf("Chrome") === -1,
            Q = h.match(/Version\/(.*?) /),
            f = p && Q && parseInt(Q[1], 10) < 15;
          return (
            (s._codecs = {
              mp3: !!(!m && (d || r.canPlayType("audio/mp3;").replace(/^no$/, ""))),
              mpeg: !!d,
              ...
              weba: !!(!f && r.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
              webm: !!(!f && r.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
        ...
        _unlockAudio: function () {
          ...
          if (!(s._audioUnlocked || !s.ctx)) {
            ...
            var r = function (d) {
              ...
              for (var b = 0; b < s._howls.length; b++)
                if (!s._howls[b]._webAudio)
                  for (var m = s._howls[b]._getSoundIds(), p = 0; p < m.length; p++) {
                    var Q = s._howls[b]._soundById(m[p]);
                    Q && Q._node && !Q._node._unlocked && ((Q._node._unlocked = !0), Q._node.load());
                  }
              s._autoResume();
              var f = s.ctx.createBufferSource();
              ((f.buffer = s._scratchBuffer),
                f.connect(s.ctx.destination),
                typeof f.start > "u" ? f.noteOn(0) : f.start(0),
          ...
          if (!(!s.autoSuspend || !s.ctx || typeof s.ctx.suspend > "u" || !t.usingWebAudio)) {
            for (var r = 0; r < s._howls.length; r++)
              if (s._howls[r]._webAudio) {
                for (var d = 0; d < s._howls[r]._sounds.length; d++) if (!s._howls[r]._sounds[d]._paused) return s;
              }
            return (
          ...
          if (!(!s.ctx || typeof s.ctx.resume > "u" || !t.usingWebAudio))
            return (
              s.state === "running" && s.ctx.state !== "interrupted" && s._suspendTimer
                ...
                : s.state === "suspended" || (s.state === "running" && s.ctx.state === "interrupted")
                  ? (s.ctx.resume().then(function () {
                      s.state = "running";
                      for (var r = 0; r < s._howls.length; r++) s._howls[r]._emit("resume");
                    }),
                    s._suspendTimer && (clearTimeout(s._suspendTimer), (s._suspendTimer = null)))
      ...
      e.prototype = {
        ...
        load: function () {
          ...
          return (
            (s._src = r),
            (s._state = "loading"),
            window.location.protocol === "https:" && r.slice(0, 5) === "http:" && ((s._html5 = !0), (s._webAudio = !1)),
            new n(s),
            s._webAudio && a(s),
            s
          );
        ...
        play: function (s, r) {
          ...
          if (typeof s == "number") ((h = s), (s = null));
            ...
            if (typeof s > "u" && ((s = "__default"), !d._playLock)) {
              for (var b = 0, m = 0; m < d._sounds.length; m++)
                d._sounds[m]._paused && !d._sounds[m]._ended && (b++, (h = d._sounds[m]._id));
              b === 1 ? (s = null) : (h = null);
            }
          }
          ...
          var f = Math.max(0, p._seek > 0 ? p._seek : d._sprite[s][0] / 1e3),
            F = Math.max(0, (d._sprite[s][0] + d._sprite[s][1]) / 1e3 - f),
            C = (F * 1e3) / Math.abs(p._rate),
            I = d._sprite[s][0] / 1e3,
          ...
          if (d._webAudio) {
            var E = function () {
              ((d._playLock = !1), y(), d._refreshBuffer(p));
              var L = p._muted || d._muted ? 0 : p._volume;
              (x.gain.setValueAtTime(L, t.ctx.currentTime),
                (p._playStart = t.ctx.currentTime),
                typeof x.bufferSource.start > "u"
                  ? p._loop
                    ? x.bufferSource.noteGrainOn(0, f, 86400)
                    : x.bufferSource.noteGrainOn(0, f, F)
                  : p._loop
                    ? x.bufferSource.start(0, f, 86400)
                    : x.bufferSource.start(0, f, F),
                C !== 1 / 0 && (d._endTimers[p._id] = setTimeout(d._ended.bind(d, p), C)),
                r ||
                  setTimeout(function () {
            ...
            t.state === "running" && t.ctx.state !== "interrupted"
              ? E()
              : ((d._playLock = !0), d.once("resume", E), d._clearTimer(p._id));
          } else {
            var v = function () {
              ((x.currentTime = f),
              ...
              try {
                var L = x.play();
                if (
                  (L && typeof Promise < "u" && (L instanceof Promise || typeof L.then == "function")
                    ? ((d._playLock = !0),
                      y(),
                      L.then(function () {
                    ...
                    : r || ((d._playLock = !1), y(), d._emit("play", p._id)),
                  (x.playbackRate = p._rate),
                  x.paused)
                ) {
                  d._emit(
                ...
                s !== "__default" || p._loop
                  ? (d._endTimers[p._id] = setTimeout(d._ended.bind(d, p), C))
                ...
                d._emit("playerror", p._id, z);
              }
            };
            x.src === "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" &&
              ((x.src = d._src), x.load());
            var X = (window && window.ejecta) || (!x.readyState && t._navigator.isCocoonJS);
            if (x.readyState >= 3 || X) v();
            else {
              ((d._playLock = !0), (d._state = "loading"));
              var G = function () {
                ((d._state = "loaded"), v(), x.removeEventListener(t._canPlayEvent, G, !1));
              };
              (x.addEventListener(t._canPlayEvent, G, !1), d._clearTimer(p._id));
            }
          }
          return p._id;
        },
        pause: function (s) {
          ...
          for (var d = r._getSoundIds(s), h = 0; h < d.length; h++) {
            r._clearTimer(d[h]);
            var b = r._soundById(d[h]);
            if (
              b &&
              !b._paused &&
              ((b._seek = r.seek(d[h])), (b._rateSeek = 0), (b._paused = !0), r._stopFade(d[h]), b._node)
            )
              if (r._webAudio) {
                if (!b._node.bufferSource) continue;
                (typeof b._node.bufferSource.stop > "u"
                  ? b._node.bufferSource.noteOff(0)
                  : b._node.bufferSource.stop(0),
                  r._cleanBuffer(b._node));
              } else (!isNaN(b._node.duration) || b._node.duration === 1 / 0) && b._node.pause();
            arguments[1] || r._emit("pause", b ? b._id : null);
          }
          return r;
        },
        stop: function (s, r) {
          ...
          for (var h = d._getSoundIds(s), b = 0; b < h.length; b++) {
            d._clearTimer(h[b]);
            var m = d._soundById(h[b]);
            m &&
              ((m._seek = m._start || 0),
              (m._rateSeek = 0),
              (m._paused = !0),
              ...
              m._node &&
                (d._webAudio
                  ...
                  : (!isNaN(m._node.duration) || m._node.duration === 1 / 0) &&
                    ...
                    m._node.pause(),
                    m._node.duration === 1 / 0 && d._clearSound(m._node))),
              r || d._emit("stop", m._id));
          }
          return d;
        },
        mute: function (s, r) {
          ...
          for (var h = d._getSoundIds(r), b = 0; b < h.length; b++) {
            var m = d._soundById(h[b]);
            m &&
              ((m._muted = s),
              m._interval && d._stopFade(m._id),
              d._webAudio && m._node
                ? m._node.gain.setValueAtTime(s ? 0 : m._volume, t.ctx.currentTime)
                : m._node && (m._node.muted = t._muted ? !0 : s),
              d._emit("mute", m._id));
          }
          return d;
        },
        volume: function () {
          ...
          if (r.length === 1 || (r.length === 2 && typeof r[1] > "u")) {
            var b = s._getSoundIds(),
              m = b.indexOf(r[0]);
            m >= 0 ? (h = parseInt(r[0], 10)) : (d = parseFloat(r[0]));
        ...
        fade: function (s, r, d, h) {
          ...
          ((s = Math.min(Math.max(0, parseFloat(s)), 1)),
            ...
            (d = parseFloat(d)),
            b.volume(s, h));
          for (var m = b._getSoundIds(h), p = 0; p < m.length; p++) {
            var Q = b._soundById(m[p]);
            if (Q) {
              if ((h || b._stopFade(m[p]), b._webAudio && !Q._muted)) {
                var f = t.ctx.currentTime,
                  F = f + d / 1e3;
                ((Q._volume = s), Q._node.gain.setValueAtTime(s, f), Q._node.gain.linearRampToValueAtTime(r, F));
              }
              b._startFadeInterval(Q, s, r, d, m[p], typeof h > "u");
            }
          }
          return b;
        },
        _startFadeInterval: function (s, r, d, h, b, m) {
          var p = this,
            Q = r,
            f = d - r,
            F = Math.abs(f / 0.01),
            C = Math.max(4, F > 0 ? h / F : h),
            I = Date.now();
          ((s._fadeTo = d),
            (s._interval = setInterval(function () {
              ...
              ((I = Date.now()),
                ...
                f < 0 ? (Q = Math.max(d, Q)) : (Q = Math.min(d, Q)),
                p._webAudio ? (s._volume = Q) : p.volume(Q, s._id, !0),
                m && (p._volume = Q),
                ((d < r && Q <= d) || (d > r && Q >= d)) &&
        ...
        loop: function () {
          ...
          if (r.length === 1)
            ...
            else return ((b = s._soundById(parseInt(r[0], 10))), b ? b._loop : !1);
          else r.length === 2 && ((d = r[0]), (h = parseInt(r[1], 10)));
          for (var m = s._getSoundIds(h), p = 0; p < m.length; p++)
            ((b = s._soundById(m[p])),
              b &&
                ((b._loop = d),
                s._webAudio &&
        ...
        rate: function () {
          ...
          if (typeof d == "number") {
            ...
            for (var Q = 0; Q < h.length; Q++)
              if (((p = s._soundById(h[Q])), p)) {
                (s.playing(h[Q]) &&
                  ((p._rateSeek = s.seek(h[Q])), (p._playStart = s._webAudio ? t.ctx.currentTime : p._playStart)),
                  (p._rate = d),
                  s._webAudio && p._node && p._node.bufferSource
                    ? p._node.bufferSource.playbackRate.setValueAtTime(d, t.ctx.currentTime)
                    : p._node && (p._node.playbackRate = d));
                var f = s.seek(h[Q]),
                  F = (s._sprite[p._sprite][0] + s._sprite[p._sprite][1]) / 1e3 - f,
                  C = (F * 1e3) / Math.abs(p._rate);
                ((s._endTimers[h[Q]] || !p._paused) &&
                  (s._clearTimer(h[Q]), (s._endTimers[h[Q]] = setTimeout(s._ended.bind(s, p), C))),
                  s._emit("rate", p._id));
              }
        ...
        seek: function () {
          ...
          if (r.length === 0) s._sounds.length && (h = s._sounds[0]._id);
            ...
            var b = s._getSoundIds(),
              m = b.indexOf(r[0]);
            m >= 0 ? (h = parseInt(r[0], 10)) : s._sounds.length && ((h = s._sounds[0]._id), (d = parseFloat(r[0])));
          } else r.length === 2 && ((d = parseFloat(r[0])), (h = parseInt(r[1], 10)));
          ...
          if (p)
            if (typeof d == "number" && d >= 0) {
              ...
              var f = function () {
                (Q && s.play(h, !0), s._emit("seek", h));
              };
              if (Q && !s._webAudio) {
                var F = function () {
                  s._playLock ? setTimeout(F, 0) : f();
                };
                setTimeout(F, 0);
              } else f();
            } else if (s._webAudio) {
              var C = s.playing(h) ? t.ctx.currentTime - p._playStart : 0,
                I = p._rateSeek ? p._rateSeek - p._seek : 0;
              return p._seek + (I + C * Math.abs(p._rate));
        ...
        playing: function (s) {
          ...
          for (var h = 0; h < r._sounds.length; h++) if (!r._sounds[h]._paused) return !0;
          return !1;
        },
        duration: function (s) {
          var r = this,
        ...
        on: function (s, r, d, h) {
          var b = this,
            m = b["_on" + s];
          return (typeof r == "function" && m.push(h ? { id: d, fn: r, once: h } : { id: d, fn: r }), b);
        },
        off: function (s, r, d) {
          var h = this,
            b = h["_on" + s],
          ...
          if ((typeof r == "number" && ((d = r), (r = null)), r || d))
            ...
            var Q = Object.keys(h);
            for (m = 0; m < Q.length; m++) Q[m].indexOf("_on") === 0 && Array.isArray(h[Q[m]]) && (h[Q[m]] = []);
          }
          return h;
        },
        once: function (s, r, d) {
        ...
        _emit: function (s, r, d) {
          for (var h = this, b = h["_on" + s], m = b.length - 1; m >= 0; m--)
            (!b[m].id || b[m].id === r || s === "load") &&
              (setTimeout(
                function (p) {
                  p.call(this, r, d);
                }.bind(h, b[m].fn),
              ...
              b[m].once && h.off(s, b[m].fn, b[m].id));
        ...
        _ended: function (s) {
          ...
          if ((r._emit("end", s._id), !r._webAudio && h && r.stop(s._id, !0).play(s._id), r._webAudio && h)) {
            ...
            var b = ((s._stop - s._start) * 1e3) / Math.abs(s._rate);
            r._endTimers[s._id] = setTimeout(r._ended.bind(r, s), b);
          }
          return (
            r._webAudio &&
              !h &&
        ...
        _soundById: function (s) {
          for (var r = this, d = 0; d < r._sounds.length; d++) if (s === r._sounds[d]._id) return r._sounds[d];
          return null;
        },
        _inactiveSound: function () {
          var s = this;
          s._drain();
          for (var r = 0; r < s._sounds.length; r++) if (s._sounds[r]._ended) return s._sounds[r].reset();
          return new n(s);
        },
        _drain: function () {
          var s = this,
          ...
          if (!(s._sounds.length < r)) {
            ...
            for (h = s._sounds.length - 1; h >= 0; h--) {
              if (d <= r) return;
              s._sounds[h]._ended &&
                (s._webAudio && s._sounds[h]._node && s._sounds[h]._node.disconnect(0), s._sounds.splice(h, 1), d--);
            }
          }
        },
        ...
        _cleanBuffer: function (s) {
          ...
          if (t._scratchBuffer && s.bufferSource && ((s.bufferSource.onended = null), s.bufferSource.disconnect(0), d))
            try {
      ...
      n.prototype = {
        ...
        create: function () {
          ...
          return (
            r._webAudio
              ? ((s._node = typeof t.ctx.createGain > "u" ? t.ctx.createGainNode() : t.ctx.createGain()),
      ...
      var i = {},
        a = function (s) {
          ...
          if (/^data:[^;]+;base64,/.test(r)) {
            for (var d = atob(r.split(",")[1]), h = new Uint8Array(d.length), b = 0; b < d.length; ++b)
              h[b] = d.charCodeAt(b);
            c(h.buffer, s);
          } else {
            var m = new XMLHttpRequest();
            (m.open(s._xhr.method, r, !0),
              (m.withCredentials = s._xhr.withCredentials),
              (m.responseType = "arraybuffer"),
              s._xhr.headers &&
                Object.keys(s._xhr.headers).forEach(function (p) {
                  m.setRequestHeader(p, s._xhr.headers[p]);
                }),
              (m.onload = function () {
                var p = (m.status + "")[0];
                if (p !== "0" && p !== "2" && p !== "3") {
                  s._emit("loaderror", null, "Failed loading audio file with status: " + m.status + ".");
                  return;
                }
                c(m.response, s);
              }),
        ...
        c = function (s, r) {
          var d = function () {
            ...
            h = function (b) {
              b && r._sounds.length > 0 ? ((i[r._src] = b), u(r, b)) : d();
            };
        ...
        u = function (s, r) {
          (r && !s._duration && (s._duration = r.duration),
            Object.keys(s._sprite).length === 0 && (s._sprite = { __default: [0, s._duration * 1e3] }),
      ...
      (typeof define == "function" &&
        ...
        typeof Oe < "u" && ((Oe.Howler = t), (Oe.Howl = e)),
        typeof global < "u"
      ...
      ((HowlerGlobal.prototype._pos = [0, 0, 0]),
        ...
        (HowlerGlobal.prototype.orientation = function (t, e, n, i, a, l) {
          ...
          if (
            ...
            (i = typeof i != "number" ? u[3] : i),
            (a = typeof a != "number" ? u[4] : a),
            (l = typeof l != "number" ? u[5] : l),
            typeof t == "number")
          )
            ((c._orientation = [t, e, n, i, a, l]),
              typeof c.ctx.listener.forwardX < "u"
                ? (c.ctx.listener.forwardX.setTargetAtTime(t, Howler.ctx.currentTime, 0.1),
                  ...
                  c.ctx.listener.upY.setTargetAtTime(a, Howler.ctx.currentTime, 0.1),
                  c.ctx.listener.upZ.setTargetAtTime(l, Howler.ctx.currentTime, 0.1))
                : c.ctx.listener.setOrientation(t, e, n, i, a, l));
          else return u;
          return c;
        }),
                  ...
                  u._node &&
                    ...
                    typeof u._panner.positionX < "u"
                      ? (u._panner.positionX.setValueAtTime(t, Howler.ctx.currentTime),
                        ...
                        u._panner.positionZ.setValueAtTime(n, Howler.ctx.currentTime))
                      : u._panner.setPosition(t, e, n)),
                  a._emit("pos", u._id));
              else return u._pos;
          }
          return a;
        ...
        (Howl.prototype.orientation = function (t, e, n, i) {
          ...
          if (
            ((e = typeof e != "number" ? a._orientation[1] : e),
          ...
          for (var l = a._getSoundIds(i), c = 0; c < l.length; c++) {
            ...
            if (u)
              if (typeof t == "number")
                ((u._orientation = [t, e, n]),
                  u._node &&
                    (u._panner || (u._pos || (u._pos = a._pos || [0, 0, -0.5]), o(u, "spatial")),
                    typeof u._panner.orientationX < "u"
                      ? (u._panner.orientationX.setValueAtTime(t, Howler.ctx.currentTime),
                        ...
                        u._panner.orientationZ.setValueAtTime(n, Howler.ctx.currentTime))
                      : u._panner.setOrientation(t, e, n)),
        ...
        (Howl.prototype.pannerAttr = function () {
            ...
            if (typeof e[0] == "object")
              ((n = e[0]),
                typeof i > "u" &&
                  ...
                  (t._pannerAttr = {
                    coneInnerAngle:
                      typeof n.pannerAttr.coneInnerAngle < "u" ? n.pannerAttr.coneInnerAngle : t._coneInnerAngle,
                    coneOuterAngle:
                      typeof n.pannerAttr.coneOuterAngle < "u" ? n.pannerAttr.coneOuterAngle : t._coneOuterAngle,
                    coneOuterGain:
                      typeof n.pannerAttr.coneOuterGain < "u" ? n.pannerAttr.coneOuterGain : t._coneOuterGain,
                    distanceModel:
                      typeof n.pannerAttr.distanceModel < "u" ? n.pannerAttr.distanceModel : t._distanceModel,
                    ...
                    rolloffFactor:
                      typeof n.pannerAttr.rolloffFactor < "u" ? n.pannerAttr.rolloffFactor : t._rolloffFactor,
          ...
          for (var l = t._getSoundIds(i), c = 0; c < l.length; c++)
            if (((a = t._soundById(l[c])), a)) {
              ...
              var g = a._panner;
              (g || (a._pos || (a._pos = t._pos || [0, 0, -0.5]), o(a, "spatial"), (g = a._panner)),
                (g.coneInnerAngle = u.coneInnerAngle),
                (g.coneOuterAngle = u.coneOuterAngle),
                (g.coneOuterGain = u.coneOuterGain),
                (g.distanceModel = u.distanceModel),
                (g.maxDistance = u.maxDistance),
                (g.refDistance = u.refDistance),
                (g.rolloffFactor = u.rolloffFactor),
                (g.panningModel = u.panningModel));
            }
          return t;
        }),
          ...
          1: [
            function (o, t, e) {
              t.exports = function (n) {
                var i = 2.5949095;
                return (n *= 2) < 1 ? n * n * ((i + 1) * n - i) * 0.5 : 0.5 * ((n -= 2) * n * ((i + 1) * n + i) + 2);
              };
            },
            {},
          ],
            ...
            function (o, t, e) {
              t.exports = function (n) {
                return n < 0.5
                  ...
                  : 0.5 * Math.sin(((-13 * Math.PI) / 2) * (2 * n - 1 + 1)) * Math.pow(2, -10 * (2 * n - 1)) + 1;
              };
            },
            {},
          ],
          ...
          34: [
            function (o, t, e) {
              ...
              var c,
                ...
                b = function (I) {
                  return isNaN((0, n.default)(I)[0]) === !1;
                },
                m = function (I) {
                  var w = (0, n.default)(I);
                ...
                p = function (I) {
                  return String(I).match(/^[a-z]+-[a-z]+$/) !== null;
                },
                Q = function (I, w) {
                  return I === !0 ? w.elem : I instanceof HTMLElement ? w.direct : w.global;
                },
                f = function (I, w) {
                  var y = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : d(),
                    x = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : h(),
                  ...
                  return (
                    ...
                    X === "bottom" && (G -= x),
                    v === "top" && (G += E.top + y),
                    v === "middle" && (G += E.top + y + E.height / 2),
                    v === "bottom" && (G += E.top + y + E.height),
                    "".concat(G, "px")
                  );
                },
                F = function (I) {
                  var w = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : d(),
                    y = I.getData(),
                    x = y.to.value - y.from.value,
                    E = w - y.from.value,
                    v = E / (x / 100),
                    X = Math.min(Math.max(v, 0), 100),
                    G = Q(y.direct, {
                      global: document.documentElement,
                      elem: y.elem,
                      direct: y.direct,
                    }),
                    L = Object.keys(y.props).reduce(function (Jt, Ht) {
                      var lt = y.props[Ht],
                        Kt = lt.from.unit || lt.to.unit,
                        po = lt.from.value - lt.to.value,
                        Qo = lt.timing(X / 100),
                        fo = lt.from.value - po * Qo,
                        Bo = Math.round(1e4 * fo) / 1e4;
                      return ((Jt[Ht] = Bo + Kt), Jt);
                    }, {}),
                    z = v >= 0 && v <= 100,
                    Ye = v < 0 || v > 100;
                  return (z === !0 && y.inside(I, v, L), Ye === !0 && y.outside(I, v, L), { elem: G, props: L });
                },
                C = function (I, w) {
                  Object.keys(w).forEach(function (y) {
                    return (function (x, E) {
                      x.style.setProperty(E.key, E.value);
                    })(I, { key: y, value: w[y] });
                  });
                };
              ((e.create = function (I) {
                  ...
                  x = {
                    ...
                    calculate: function () {
                      w = (function () {
                        ...
                        if (
                          ((v = Object.assign({}, v)).inside == null && (v.inside = function () {}),
                          v.outside == null && (v.outside = function () {}),
                          v.direct == null && (v.direct = !1),
                          v.track == null && (v.track = !0),
                          v.props == null && (v.props = {}),
                          v.from == null)
                        )
                          throw new Error("Missing property `from`");
                        if (v.to == null) throw new Error("Missing property `to`");
                        if (typeof v.inside != "function")
                          throw new Error("Property `inside` must be undefined or a function");
                        if (typeof v.outside != "function")
                          throw new Error("Property `outside` must be undefined or a function");
                        if (typeof v.direct != "boolean" && v.direct instanceof HTMLElement == 0)
                          throw new Error("Property `direct` must be undefined, a boolean or a DOM element/node");
                        if (v.direct === !0 && v.elem == null)
                          throw new Error("Property `elem` is required when `direct` is true");
                        if (typeof v.track != "boolean")
                          throw new Error("Property `track` must be undefined or a boolean");
                        if (l(v.props) !== "object") throw new Error("Property `props` must be undefined or an object");
                        if (v.elem == null) {
                          if (b(v.from) === !1)
                            throw new Error(
                          ...
                          (p(v.from) === !0 && (v.from = f(v.from, v.elem)),
                            p(v.to) === !0 && (v.to = f(v.to, v.elem)));
                        return (
                          (v.from = m(v.from)),
                          (v.to = m(v.to)),
                          (v.props = Object.keys(v.props).reduce(function (X, G) {
                            var L = Object.assign({}, v.props[G]);
                            if (b(L.from) === !1) throw new Error("Property `from` of prop must be a absolute value");
                            if (b(L.to) === !1) throw new Error("Property `from` of prop must be a absolute value");
                            if (
                              ((L.from = m(L.from)),
                              (L.to = m(L.to)),
                              L.timing == null && (L.timing = i.default.linear),
                              typeof L.timing != "string" && typeof L.timing != "function")
                            )
                            ...
                            return (typeof L.timing == "string" && (L.timing = i.default[L.timing]), (X[G] = L), X);
                          }, {})),
                          v
                        );
                      })(I);
                    ...
                    window.addEventListener(
                      ...
                      ((c = function () {
                        (function (I) {
                          ...
                          (I.calculate(), I.update());
                        });
                      }),
                      (u = 50),
                      (g = null),
                      function () {
                        for (var I = arguments.length, w = new Array(I), y = 0; y < I; y++) w[y] = arguments[y];
                        (clearTimeout(g),
  ...
  function ke(o) {
    return dn(o.replace(/--/g, "-").replace(/__/g, "_"));
  }
  function Lt(o) {
  ...
  var oi = ["meta", "ctrl", "alt", "shift"],
    Re = class {
      constructor(t, e, n, i) {
        ((this.element = t),
          (this.index = e),
          (this.eventTarget = n.eventTarget || t),
          (this.eventName = n.eventName || Zo(t) || qt("missing event name")),
          (this.eventOptions = n.eventOptions || {}),
          (this.identifier = n.identifier || qt("missing identifier")),
          (this.methodName = n.methodName || qt("missing method name")),
      ...
      shouldIgnoreKeyboardEvent(t) {
        ...
        let n = e.filter((i) => !oi.includes(i))[0];
        return n
          ? (Se(this.keyMappings, n) || qt(`contains unknown key filter: ${this.keyFilter}`),
      ...
      get eventTargetName() {
        return Go(this.eventTarget);
      }
      get keyMappings() {
        return this.schema.keyMappings;
      }
      keyFilterDissatisfied(t, e) {
        let [n, i, a, l] = oi.map((c) => e.includes(c));
  ...
  var Te = class {
      ...
      applyEventModifiers(t) {
        ...
        for (let [l, c] of Object.entries(this.eventOptions))
          if (l in n) {
            let u = n[l];
            a = a && u({ name: l, value: c, event: t, element: e, controller: i });
          } else continue;
        return a;
      }
      ...
      invokeWithEvent(t) {
        ...
        try {
          ...
          let { identifier: a, controller: l, element: c, index: u } = this,
            g = { identifier: a, controller: l, element: c, index: u, event: t };
          this.context.handleError(i, `invoking action "${this.action}"`, g);
        }
      }
    ...
    te = class {
      ...
      processMutation(t) {
        t.type == "attributes"
          ...
          : t.type == "childList" && (this.processRemovedNodes(t.removedNodes), this.processAddedNodes(t.addedNodes));
      }
    ...
    ee = class {
      constructor(t, e, n) {
        ((this.attributeName = e), (this.delegate = n), (this.elementObserver = new te(t, this)));
      }
      get element() {
  ...
  var it = class {
    ...
    add(t, e) {
      Eo(this.valuesByKey, t, e);
    }
    delete(t, e) {
      No(this.valuesByKey, t, e);
    }
    has(t, e) {
  ...
  var ze = class {
      constructor(t, e, n, i) {
        ((this._selector = e),
          (this.details = i),
          (this.elementObserver = new te(t, this)),
          (this.delegate = n),
    ...
    ne = class {
      constructor(t, e, n) {
        ((this.attributeObserver = new ee(t, e, this)), (this.delegate = n), (this.tokensByElement = new it()));
      }
      get started() {
  ...
  var ie = class {
      constructor(t, e, n) {
        ((this.tokenListObserver = new ne(t, e, this)),
          (this.delegate = n),
    ...
    Je = class {
      ...
      start() {
        this.valueListObserver ||
          ((this.valueListObserver = new ie(this.element, this.actionAttribute, this)), this.valueListObserver.start());
      }
      stop() {
        this.valueListObserver &&
      ...
      parseValueForToken(t) {
        let e = Re.forToken(t, this.schema);
    ...
    He = class {
      constructor(t, e) {
        ((this.context = t),
          (this.receiver = e),
          (this.stringMapObserver = new _e(this.element, this)),
    ...
    Ke = class {
      ...
      start() {
        this.tokenListObserver ||
          ((this.tokenListObserver = new ne(this.element, this.attributeName, this)), this.tokenListObserver.start());
      }
      stop() {
        this.tokenListObserver &&
      ...
      connectTarget(t, e) {
        ...
        this.targetsByName.has(e, t) ||
          ...
          (n = this.tokenListObserver) === null || n === void 0 || n.pause(() => this.delegate.targetConnected(t, e)));
      }
  ...
  function At(o, t) {
    let e = bi(o);
    return Array.from(e.reduce((n, i) => (Ro(i, t).forEach((a) => n.add(a)), n), new Set()));
  }
  function So(o, t) {
    return bi(o).reduce((n, i) => (n.push(...To(i, t)), n), []);
  }
  function bi(o) {
    let t = [];
      ...
      get outletDependencies() {
        ...
        return (
          this.router.modules.forEach((e) => {
            ...
            At(n, "outlets").forEach((a) => t.add(a, e.identifier));
          }),
          t
        );
      }
    ...
    $e = class {
      constructor(t, e) {
        ((this.logDebugActivity = (n, i = {}) => {
          let { identifier: a, controller: l, element: c } = this;
          ((i = Object.assign({ identifier: a, controller: l, element: c }, i)),
          ...
          (this.valueObserver = new He(this, this.controller)),
          (this.targetObserver = new Ke(this, this)),
          (this.outletObserver = new Pe(this, this)));
        try {
      ...
      handleError(t, e, n = {}) {
        let { identifier: i, controller: a, element: l } = this;
        ((n = Object.assign({ identifier: i, controller: a, element: l }, n)),
          this.application.handleError(t, `Error ${e}`, n));
      }
      targetConnected(t, e) {
      ...
      outletConnected(t, e, n) {
        this.invokeControllerMethod(`${ke(n)}OutletConnected`, t, e);
      }
      outletDisconnected(t, e, n) {
        this.invokeControllerMethod(`${ke(n)}OutletDisconnected`, t, e);
      }
  ...
  function Jo(o) {
    return At(o, "blessings").reduce((e, n) => {
      let i = n(o);
      for (let a in i) {
        let l = e[a] || {};
  ...
  function qo(o) {
    return { identifier: o.identifier, controllerConstructor: zo(o.controllerConstructor) };
  }
  var qe = class {
      constructor(t, e) {
        ((this.application = t),
          (this.definition = qo(e)),
      ...
      fetchContextForScope(t) {
        let e = this.contextsByScope.get(t);
        return (e || ((e = new $e(this, t)), this.contextsByScope.set(t, e)), e);
      }
    },
    tn = class {
      constructor(t) {
  ...
  var sn = class {
      ...
      getLegacySelectorForTargetName(t) {
        ...
        return on(this.schema.targetAttribute, e);
      }
      deprecate(t, e) {
        if (t) {
          let { identifier: n } = this,
            i = this.schema.targetAttribute,
            a = this.schema.targetAttributeForScope(n);
          this.guide.warn(
            t,
            `target:${e}`,
            `Please replace ${i}="${n}.${e}" with ${a}="${e}". The ${i} attribute is deprecated and will be removed in a future version of Stimulus.`,
          );
        }
        return t;
      }
    ...
    rn = class o {
      constructor(t, e, n, i) {
        ((this.targets = new sn(this)),
          (this.classes = new tn(this)),
          (this.data = new en(this)),
          (this.containsElement = (a) => a.closest(this.controllerSelector) === this.element),
          (this.schema = t),
          (this.element = e),
          (this.identifier = n),
          (this.guide = new nn(i)),
          (this.outlets = new an(this.documentScope, e)));
      }
      findElement(t) {
      ...
      get controllerSelector() {
        return on(this.schema.controllerAttribute, this.identifier);
      }
      get isDocumentScope() {
    ...
    ln = class {
      constructor(t, e, n) {
        ((this.element = t),
          (this.schema = e),
          (this.delegate = n),
          (this.valueListObserver = new ie(this.element, this.controllerAttribute, this)),
    ...
    cn = class {
      constructor(t) {
        ((this.application = t),
          (this.scopeObserver = new ln(this.element, this.schema, this)),
      ...
      createScopeForElementAndIdentifier(t, e) {
        return new rn(this.schema, t, e, this.logger);
      }
      scopeConnected(t) {
    ...
    ts = {
      ...
      keyMappings: Object.assign(
        Object.assign(
          ...
          ai("abcdefghijklmnopqrstuvwxyz".split("").map((o) => [o, o])),
        ),
        ai("0123456789".split("").map((o) => [o, o])),
      ),
    };
  function ai(o) {
  ...
  var oe = class {
    constructor(t = document.documentElement, e = ts) {
      ((this.logger = console),
        (this.debug = !1),
        (this.logDebugActivity = (n, i, a = {}) => {
          this.debug && this.logFormattedMessage(n, i, a);
        }),
        (this.element = t),
        (this.schema = e),
        (this.dispatcher = new Ve(this)),
        (this.router = new cn(this)),
        (this.actionDescriptorFilters = Object.assign({}, Lo)));
    }
    static start(t, e) {
      let n = new this(t, e);
      return (n.start(), n);
...
%o`,
  ...
  function ns(o) {
    return At(o, "classes").reduce((e, n) => Object.assign(e, is(n)), {});
  }
  function is(o) {
    return {
      [`${o}Class`]: {
  ...
  function os(o) {
    return At(o, "outlets").reduce((e, n) => Object.assign(e, ss(n)), {});
  }
  function ri(o, t, e) {
  ...
  function li(o, t, e) {
    let n = ri(o, t, e);
    if (n || (o.application.router.proposeToConnectScopeForElementAndIdentifier(t, e), (n = ri(o, t, e)), n)) return n;
  }
  function ss(o) {
    let t = ke(o);
    return {
  ...
  function as(o) {
    return At(o, "targets").reduce((e, n) => Object.assign(e, rs(n)), {});
  }
  function rs(o) {
    return {
      [`${o}Target`]: {
    ...
    let t = So(o, "values"),
      e = {
        valueDescriptorMap: {
          get() {
            return t.reduce((n, i) => {
              let a = mi(i, this.identifier),
                l = this.data.getAttributeNameForKey(a.key);
              return Object.assign(n, { [l]: a });
            }, {});
          },
        },
      };
    return t.reduce((n, i) => Object.assign(n, cs(i)), e);
  }
  function cs(o, t) {
    let e = mi(o, t),
      { key: n, name: i, reader: a, writer: l } = e;
    return {
      [i]: {
        get() {
  ...
  function mi([o, t], e) {
    return gs({ controller: e, token: o, typeDefinition: t });
  }
  function se(o) {
    switch (o) {
      case Array:
  ...
  function ds(o) {
    let { controller: t, token: e, typeObject: n } = o,
      ...
      u = !i && a,
      g = se(n.type),
      s = wt(o.typeObject.default);
    if (c) return g;
    if (u) return s;
    if (g !== s) {
      let r = t ? `${t}.${e}` : e;
      throw new Error(
        `The specified default value for the Stimulus Value "${r}" must match the defined type "${g}". The provided default value of "${n.default}" is of type "${s}".`,
      );
    }
    if (l) return g;
  }
  function us(o) {
    let { controller: t, token: e, typeDefinition: n } = o,
      a = ds({ controller: t, token: e, typeObject: n }),
      l = wt(n),
      c = se(n),
      u = a || l || c;
    if (u) return u;
    let g = t ? `${t}.${n}` : e;
    throw new Error(`Unknown value type "${g}" for "${e}" value`);
  }
  function hs(o) {
    let t = se(o);
    if (t) return ci[t];
  ...
  var ci = {
    ...
    bs = {
      array(o) {
        let t = JSON.parse(o);
        if (!Array.isArray(t))
          throw new TypeError(`expected value of type "array" but instead got value "${o}" of type "${wt(t)}"`);
        return t;
      },
      boolean(o) {
      ...
      object(o) {
        ...
        if (t === null || typeof t != "object" || Array.isArray(t))
          throw new TypeError(`expected value of type "object" but instead got value "${o}" of type "${wt(t)}"`);
        return t;
      },
      string(o) {
        return o;
    ...
    di = { default: ms, array: ui, object: ui };
  function ui(o) {
  ...
  var A = class {
    ...
    dispatch(
      ...
      let c = i ? `${i}:${t}` : t,
        u = new CustomEvent(c, { detail: n, bubbles: a, cancelable: l });
      return (e.dispatchEvent(u), u);
    }
  };
  A.blessings = [ns, as, ls, os];
  A.targets = [];
  A.outlets = [];
  A.values = {};
  var B = (o, t = 1e4) => ((o = parseFloat(o + "") || 0), Math.round((o + Number.EPSILON) * t) / t),
    ...
    fe = function (o, t = void 0) {
      return !(!o || o === document.body || (t && o === t)) && (wn(o) ? o : fe(o.parentElement, t));
    },
    et = function (o) {
    ...
    Qt = { passive: !1 },
    Ln = class {
      constructor(t, { start: e = () => !0, move: n = () => {}, end: i = () => {} }) {
        (Object.defineProperty(this, "element", {
          ...
          (this.moveCallback = n),
          (this.endCallback = i));
        for (let a of ["onPointerStart", "onTouchStart", "onMove", "onTouchEnd", "onPointerEnd", "onWindowBlur"])
          this[a] = this[a].bind(this);
        (this.element.addEventListener("mousedown", this.onPointerStart, Qt),
          this.element.addEventListener("touchstart", this.onTouchStart, Qt),
          this.element.addEventListener("touchmove", this.onMove, Qt),
      ...
      stop() {
        (this.element.removeEventListener("mousedown", this.onPointerStart, Qt),
          this.element.removeEventListener("touchstart", this.onTouchStart, Qt),
          this.element.removeEventListener("touchmove", this.onMove, Qt),
  ...
  function Qi(o, t) {
    return t ? { clientX: (o.clientX + t.clientX) / 2, clientY: (o.clientY + t.clientY) / 2 } : o;
  }
  var An = (o) =>
      typeof o == "object" &&
      o !== null &&
    ...
    S = (o, ...t) => {
      ...
      for (let n = 0; n < e; n++) {
        ...
        Object.entries(i).forEach(([a, l]) => {
          ...
          (o[a] || Object.assign(o, { [a]: c }),
            An(l)
              ? Object.assign(o[a], S(c, l))
              : Array.isArray(l)
                ? Object.assign(o, { [a]: [...l] })
                : Object.assign(o, { [a]: l }));
        });
    ...
    yt = class {
      ...
      setOptions(t) {
        this.options = t ? S({}, this.constructor.defaults, t) : {};
        for (let [e, n] of Object.entries(this.option("on") || {})) this.on(e, n);
      }
      option(t, ...e) {
        let n = un(t, this.options);
        return (n && typeof n == "function" && (n = n.call(this, this, ...e)), n);
      }
      optionFor(t, e, n, ...i) {
        let a = un(e, t);
        var l;
        (typeof (l = a) != "string" || isNaN(l) || isNaN(parseFloat(l)) || (a = parseFloat(a)),
          a === "true" && (a = !0),
          a === "false" && (a = !1),
          a && typeof a == "function" && (a = a.call(this, this, t, ...i)));
        let c = un(e, this.options);
        return (
          c && typeof c == "function" ? (a = c.call(this, this, t, ...i, a)) : a === void 0 && (a = c),
          a === void 0 ? n : a
        );
      }
      cn(t) {
      ...
      localize(t, e = []) {
        t = String(t).replace(/\{\{(\w+).?(\w+)?\}\}/g, (n, i, a) => {
          ...
          return (
            a
              ? (l = this.option(`${i[0] + i.toLowerCase().substring(1)}.l10n.${a}`))
  ...
  (Object.defineProperty(yt, "version", { enumerable: !0, configurable: !0, writable: !0, value: "5.0.36" }),
    Object.defineProperty(yt, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: {} }));
  ...
  var ot = ["a", "b", "c", "d", "e", "f"],
    ...
    On = '<div class="f-spinner"><svg viewBox="0 0 50 50">' + fi + fi + "</svg></div>",
    k = (o) => o && o !== null && o instanceof Element && "nodeType" in o,
    M = (o, t) => {
      o &&
        Mn(t).forEach((e) => {
    ...
    pt = class o extends Dt {
      ...
      get isTouchDevice() {
        return (gn === null && (gn = window.matchMedia("(hover: none)").matches), gn);
      }
      get isMobile() {
        return (hn === null && (hn = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent)), hn);
      }
      get panMode() {
        return this.options.panMode !== _ || this.isTouchDevice ? Bi : _;
      }
      get panOnlyZoomed() {
      ...
      constructor(t, e = {}, n = {}) {
        ...
        let a = this.content;
        if (
          (a.addEventListener("load", this.onLoad), a.addEventListener("error", this.onError), this.isContentLoading)
        ) {
          if (this.option("spinner")) {
            t.classList.add(this.cn("isLoading"));
            let l = et(On);
            !t.contains(a) || a.parentElement instanceof HTMLPictureElement
              ? (this.spinner = t.appendChild(l))
              : (this.spinner =
                  ((i = a.parentElement) === null || i === void 0 ? void 0 : i.insertBefore(l, a)) || null);
          }
      ...
      initContent() {
        let { container: t } = this,
          e = this.cn(Fi),
          n = this.option(Fi) || t.querySelector(`.${e}`);
        if (
          (n || ((n = t.querySelector("img,picture") || t.firstElementChild), n && U(n, e)),
      ...
      getNextScale(t) {
        let { fullScale: e, targetScale: n, coverScale: i, maxScale: a, minScale: l } = this,
          c = l;
        switch (t) {
          case "toggleMax":
            c = n - l < 0.5 * (a - l) ? a : l;
      ...
      checkBounds(t = 0, e = 0) {
        let { current: n } = this,
          ...
          b = 0;
        return (
          g !== 1 / 0 && i < g ? (h = g - i) : s !== 1 / 0 && i > s && (h = s - i),
          r !== 1 / 0 && a < r ? (b = r - a) : d !== 1 / 0 && a > d && (b = d - a),
          Math.abs(h) < 1e-4 && (h = 0),
          Math.abs(b) < 1e-4 && (b = 0),
          Object.assign(Object.assign({}, l), { xDiff: h, yDiff: b, inBounds: !h && !b })
        );
      }
      clampTargetBounds() {
        let { target: t } = this,
      ...
      calculateContentDim(t = this.current) {
        let { content: e, contentRect: n } = this,
          { fitWidth: i, fitHeight: a, fullWidth: l, fullHeight: c } = n,
          u = l,
          g = c;
        if (this.option("zoom") || this.angle !== 0) {
          let s =
              !(e instanceof HTMLImageElement) &&
              (window.getComputedStyle(e).maxWidth === "none" || window.getComputedStyle(e).maxHeight === "none"),
            r = s ? l : i,
            d = s ? c : a,
            h = this.getMatrix(t),
            b = new DOMPoint(0, 0).matrixTransform(h),
            m = new DOMPoint(0 + r, 0).matrixTransform(h),
            p = new DOMPoint(0 + r, 0 + d).matrixTransform(h),
            Q = new DOMPoint(0, 0 + d).matrixTransform(h),
            f = Math.abs(p.x - b.x),
            F = Math.abs(p.y - b.y),
            C = Math.abs(Q.x - m.x),
            I = Math.abs(Q.y - m.y);
          ((u = Math.max(f, C)), (g = Math.max(F, I)));
        }
        return { contentWidth: u, contentHeight: g };
      }
      setEdgeForce() {
        if (this.ignoreBounds || this.isDragging || this.panMode === _ || this.targetScale < this.scale)
          return ((this.isBouncingX = !1), void (this.isBouncingY = !1));
        let { target: t } = this,
          { x: e, y: n, xDiff: i, yDiff: a } = this.checkBounds(),
      ...
      onClick(t) {
        ...
        let u = this.content.getBoundingClientRect(),
          g = this.dragStart;
        if (g.time && !this.canZoomOut() && (Math.abs(u.x - g.x) > 2 || Math.abs(u.y - g.y) > 2)) return;
        this.dragStart.time = 0;
        let s = (h) => {
            this.option("zoom", t) &&
              h &&
              typeof h == "string" &&
              /(iterateZoom)|(toggle(Zoom|Full|Cover|Max)|(zoomTo(Fit|Cover|Max)))/.test(h) &&
      ...
      onPointerDown(t, e, n) {
        ...
        if (((this.dragStart = { x: a.x, y: a.y, top: a.top, left: a.left, time: Date.now() }), this.clickTimer))
          return !1;
      ...
      onPointerMove(t, e, n) {
        if (
          ...
          !this.isDragging ||
          (e.length < 2 && this.panOnlyZoomed && B(this.targetScale) <= B(this.minScale)) ||
        ...
        if (e.length > 1) {
          ...
          ((c = a.clientX - F.left - 0.5 * F.width), (u = a.clientY - F.top - 0.5 * F.height));
        }
        let g = pi(n[0], n[1]),
          s = pi(e[0], e[1]),
          r = g ? s / g : 1,
        ...
        let b = B(this.targetScale) === B(this.minScale) && this.option("lockAxis");
        if (b && !this.lockedAxis)
          if (b === "xy" || b === "y" || t.type === "touchmove") {
            ...
            ((this.lockedAxis = F > 45 && F < 135 ? "y" : "x"),
              (this.dragOffset.x = 0),
              (this.dragOffset.y = 0),
              (d = 0),
              (h = 0));
        ...
        if (
          (fe(t.target, this.content) && ((b = "x"), (this.dragOffset.y = 0)),
          b && b !== "xy" && this.lockedAxis !== b && B(this.targetScale) === B(this.minScale))
        )
          return;
        (t.cancelable && t.preventDefault(), this.container.classList.add(this.cn("isDragging")));
        let m = this.checkBounds(d, h);
        this.option("rubberband")
          ? (this.isInfinite !== "x" &&
              ((m.xDiff > 0 && d < 0) || (m.xDiff < 0 && d > 0)) &&
              (d *= Math.max(0, 0.5 - Math.abs((0.75 / this.contentRect.fitWidth) * m.xDiff))),
            this.isInfinite !== "y" &&
              ((m.yDiff > 0 && h < 0) || (m.yDiff < 0 && h > 0)) &&
              (h *= Math.max(0, 0.5 - Math.abs((0.75 / this.contentRect.fitHeight) * m.yDiff))))
          : (m.xDiff && (d = 0), m.yDiff && (h = 0));
        let p = this.targetScale,
          Q = this.minScale,
          f = this.maxScale;
        (p < 0.5 * Q && (r = Math.max(r, Q)),
          p > 1.5 * f && (r = Math.min(r, f)),
          this.lockedAxis === "y" && B(p) === B(Q) && (d = 0),
          this.lockedAxis === "x" && B(p) === B(Q) && (h = 0),
          this.applyChange({
            originX: c,
            originY: u,
            panX: d,
        ...
        (this.container.classList.remove(this.cn("isDragging")),
          this.isDragging &&
            ...
            this.panOnlyZoomed &&
              ...
              this.contentRect.height - this.contentRect.fitHeight < 1 &&
              (this.trackingPoints = []),
            fe(t.target, this.content) && this.lockedAxis === "y" && (this.trackingPoints = []),
      ...
      startDecelAnim() {
        ...
        let g = ((t = window.visualViewport) === null || t === void 0 ? void 0 : t.scale) || 1;
        g !== 1 && ((l *= g), (c *= g));
        let s = 0,
          r = 0,
          d = 0,
        ...
        if (u > 0) {
          ...
          F && ((d = Math.max(Math.min(d, F), -1 * F)), (h = Math.max(Math.min(h, F), -1 * F)));
        }
        (d && (s = d / (1 / (1 - b) - 1)),
          h && (r = h / (1 / (1 - b) - 1)),
          (this.option("lockAxis") === "y" ||
            (this.option("lockAxis") === "xy" && this.lockedAxis === "y" && B(m) === this.minScale)) &&
            (s = d = 0),
          (this.option("lockAxis") === "x" ||
            (this.option("lockAxis") === "xy" && this.lockedAxis === "x" && B(m) === this.minScale)) &&
            (r = h = 0));
        let p = this.dragOffset.x,
          Q = this.dragOffset.y,
          f = this.option("dragMinThreshold") || 0;
        (Math.abs(p) < f && Math.abs(Q) < f && ((s = r = 0), (d = h = 0)),
          ((this.option("zoom") && (m < this.minScale - 1e-5 || m > this.maxScale + 1e-5)) || (e && !s && !r)) &&
            (b = 0.35),
          this.applyChange({ panX: s, panY: r, friction: b }),
          this.emit("decel", d, h, p, Q));
      }
      onWheel(t) {
        ...
        if ((this.emit("wheel", t, n), this.panMode === _ || t.defaultPrevented)) return;
      ...
      setTransform() {
        ...
        for (let p of ot) {
          let Q = p == "e" || p === "f" ? re : Qs;
          ((a[p] = B(t[p], Q)), Math.abs(e[p] - t[p]) < (p == "e" || p === "f" ? 0.51 : 0.001) && (t[p] = e[p]));
        }
        let { a: l, b: c, c: u, d: g, e: s, f: r } = a,
          d = `matrix(${l}, ${c}, ${u}, ${g}, ${s}, ${r})`,
        ...
        h.style.transform = d;
        let { contentWidth: b, contentHeight: m } = this.calculateContentDim();
        ((i.width = b), (i.height = m), this.emit("afterTransform"));
      }
      updateMetrics(t = !1) {
        var e;
        ...
        let n = Math.max(1, ((e = window.visualViewport) === null || e === void 0 ? void 0 : e.scale) || 1),
          ...
          d = g - (parseFloat(u.paddingLeft) + parseFloat(u.paddingRight)),
          h = s - r;
        this.containerRect = { width: g, height: s, innerWidth: d, innerHeight: h };
        let b =
          ...
          p = this.option("width", b) || J,
          Q = this.option("height", m) || J,
          f = p === J,
          F = Q === J;
        (typeof p != "number" && (p = b),
          typeof Q != "number" && (Q = m),
          f && (p = b * (Q / m)),
          F && (Q = m / (b / p)));
        let C = a.parentElement instanceof HTMLPictureElement ? a.parentElement : a;
        this.option("transformParent") && (C = C.parentElement || C);
        let I = C.getAttribute("style") || "";
        (C.style.setProperty("transform", "none", "important"),
          l && ((C.style.width = ""), (C.style.height = "")),
          C.offsetHeight);
        ...
        ((y = Math.min(y, p)),
          (x = Math.min(x, Q)),
          l
            ? ({ width: y, height: x } = ((L, z, Ye, Jt) => {
                let Ht = Ye / L,
                  lt = Jt / z,
                  Kt = Math.min(Ht, lt);
                return { width: (L *= Kt), height: (z *= Kt) };
              })(p, Q, y, x))
            : ((y = Math.min(y, p)), (x = Math.min(x, Q))));
        let X = 0.5 * (v - x),
          G = 0.5 * (E - y);
        ((this.contentRect = Object.assign(Object.assign({}, this.contentRect), {
          top: w.top - c.top + X,
          bottom: c.bottom - w.bottom + X,
          left: w.left - c.left + G,
          right: c.right - w.right + G,
          fitWidth: y,
          fitHeight: x,
          width: y,
          height: x,
          ...
          (C.style.cssText = I),
          l && ((C.style.width = `${y}px`), (C.style.height = `${x}px`)),
          this.setTransform(),
      ...
      calculateBounds() {
        let { contentWidth: t, contentHeight: e } = this.calculateContentDim(this.target),
          ...
          { fitWidth: a, fitHeight: l } = this.contentRect,
          c = 0,
          u = 0,
          g = 0,
          s = 0,
          r = this.option("infinite");
        if (r === !0 || (i && r === i)) ((c = -1 / 0), (g = 1 / 0), (u = -1 / 0), (s = 1 / 0));
        else {
          let { containerRect: d, contentRect: h } = this,
            b = B(a * n, re),
            m = B(l * n, re),
            { innerWidth: p, innerHeight: Q } = d;
          if ((d.width === b && (p = d.width), d.width === m && (Q = d.height), t > p)) {
            ((g = 0.5 * (t - p)), (c = -1 * g));
            let f = 0.5 * (h.right - h.left);
            ((c += f), (g += f));
          }
          if ((a > p && t < p && ((c -= 0.5 * (a - p)), (g -= 0.5 * (a - p))), e > Q)) {
            ((s = 0.5 * (e - Q)), (u = -1 * s));
            let f = 0.5 * (h.bottom - h.top);
            ((u += f), (s += f));
          }
          l > Q && e < Q && ((c -= 0.5 * (l - Q)), (g -= 0.5 * (l - Q)));
        }
        return { x: { min: c, max: g }, y: { min: u, max: s } };
      }
      getBounds() {
      ...
      updateControls() {
        let t = this,
          e = t.container,
          { panMode: n, contentRect: i, targetScale: a, minScale: l } = t,
          c = l,
          u = t.option("click") || !1;
        u && (c = t.getNextScale(u));
        let g = t.canZoomIn(),
          s = t.canZoomOut(),
          r = n === Bi && !!this.option("touch"),
          d = s && r;
        if (
          (r &&
            (B(a) < B(l) && !this.panOnlyZoomed && (d = !0),
            (B(i.width, 1) > B(i.fitWidth, 1) || B(i.height, 1) > B(i.fitHeight, 1)) && (d = !0)),
          B(i.width * a, 1) < B(i.fitWidth, 1) && (d = !1),
          n === _ && (d = !1),
          nt(e, this.cn("isDraggable"), d),
          !this.option("zoom"))
        )
          return;
        let h = g && B(c) > B(a),
          b = !h && !d && s && B(c) < B(a);
        (nt(e, this.cn("canZoomIn"), h), nt(e, this.cn("canZoomOut"), b));
        for (let m of e.querySelectorAll("[data-panzoom-action]")) {
          let p = !1,
            Q = !1;
      ...
      applyChange({
        ...
        let { current: h } = this,
          ...
          Q = new DOMMatrix().translate(b, m).translate(a, l).translate(t, e);
        if (this.option("zoom")) {
          if (!s) {
            let f = this.targetScale,
              F = this.minScale,
              C = this.maxScale;
            (f * n < F && (n = F / f), f * n > C && (n = C / f));
          }
          Q = Q.scale(n);
        }
        ((Q = Q.translate(-a, -l).translate(-b, -m).multiply(p)),
          i && (Q = Q.rotate(i)),
          u && (Q = Q.scale(-1, 1)),
          g && (Q = Q.scale(1, -1)));
        for (let f of ot)
          f !== "e" && f !== "f" && (Q[f] > this.minScale + 1e-5 || Q[f] < this.minScale - 1e-5)
            ? (this.target[f] = Q[f])
            : (this.target[f] = B(Q[f], re));
        ((this.targetScale < this.scale || Math.abs(n - 1) > 0.1 || this.panMode === _ || r === !1) &&
          !s &&
      ...
      requestTick() {
        (this.isTicking ||
          ...
          this.isScaling && U(this.container, "is-scaling")),
          (this.isTicking = !0),
          this.rAF || (this.rAF = requestAnimationFrame(() => this.animate())));
      }
      panWithMouse(t, e = this.option("mouseMoveFriction")) {
        if (((this.pmme = t), this.panMode !== _ || !t || B(this.targetScale) <= B(this.minScale))) return;
        this.emit("mouseMove", t);
        let { container: n, containerRect: i, contentRect: a } = this,
          l = i.width,
          c = i.height,
          u = n.getBoundingClientRect(),
          g = (t.clientX || 0) - u.left,
          s = (t.clientY || 0) - u.top,
          { contentWidth: r, contentHeight: d } = this.calculateContentDim(this.target),
          h = this.option("mouseMoveFactor");
        h > 1 && (r !== l && (r *= h), d !== c && (d *= h));
        let b = 0.5 * (r - l) - (((g / l) * 100) / 100) * (r - l);
        b += 0.5 * (a.right - a.left);
        let m = 0.5 * (d - c) - (((s / c) * 100) / 100) * (d - c);
        ((m += 0.5 * (a.bottom - a.top)),
          this.applyChange({ panX: b - this.target.e, panY: m - this.target.f, friction: e }));
      }
      zoomWithWheel(t) {
        ...
        this.pwt = e;
        var n = [-t.deltaX || 0, -t.deltaY || 0, -t.detail || 0].reduce(function (g, s) {
          return Math.abs(s) > Math.abs(g) ? s : g;
        });
        let i = Math.max(-1, Math.min(1, n)),
          { targetScale: a, maxScale: l, minScale: c } = this,
          u = (a * (100 + 45 * i)) / 100;
        (B(u) < B(c) && B(a) <= B(c)
          ? ((this.cwd += Math.abs(i)), (u = c))
          : B(u) > B(l) && B(a) >= B(l)
            ? ((this.cwd += Math.abs(i)), (u = l))
            : ((this.cwd = 0), (u = Math.max(Math.min(u, l), c))),
          this.cwd > this.option("wheelLimit") || (t.preventDefault(), B(u) !== B(a) && this.zoomTo(u, { event: t })));
      }
      canZoomIn() {
        return (
          this.option("zoom") &&
          (B(this.contentRect.width, 1) < B(this.contentRect.fitWidth, 1) || B(this.targetScale) < B(this.maxScale))
        );
      }
      canZoomOut() {
      ...
      zoomTo(t = 1, { friction: e = J, originX: n = J, originY: i = J, event: a } = {}) {
        if (this.isContentLoading || this.state === O.Destroy) return;
        let { targetScale: l, fullScale: c, maxScale: u, coverScale: g } = this;
        if ((this.stop(), this.panMode === _ && (a = this.pmme || a), a || n === J || i === J)) {
          let r = this.content.getBoundingClientRect(),
            d = this.container.getBoundingClientRect(),
            h = a ? a.clientX : d.left + 0.5 * d.width,
            b = a ? a.clientY : d.top + 0.5 * d.height;
          ((n = h - r.left - 0.5 * r.width), (i = b - r.top - 0.5 * r.height));
        }
        let s = 1;
        (typeof t == "number"
          ? (s = t)
          ...
          (s = s / l || 1),
          (e = e === J ? (s > 1 ? 0.15 : 0.25) : e),
          this.applyChange({ scale: s, originX: n, originY: i, friction: e }),
          a && this.panMode === _ && this.panWithMouse(a, e));
      }
      rotateCCW() {
      ...
      toggleFS() {
        ...
        (i
          ? (document.documentElement.classList.add(n), document.addEventListener("keydown", this.onKeydown, !0))
          : (document.documentElement.classList.remove(n), document.removeEventListener("keydown", this.onKeydown, !0)),
          this.updateMetrics(),
          this.emit(i ? "enterFS" : "exitFS"));
      }
      getMatrix(t = this.current) {
        let { a: e, b: n, c: i, d: a, e: l, f: c } = t;
        return new DOMMatrix([e, n, i, a, l, c]);
      }
      reset(t) {
        if (this.state !== O.Init && this.state !== O.Destroy) {
          this.stop("current");
          for (let e of ot) this.target[e] = ae[e];
  ...
  (Object.defineProperty(pt, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: ps }),
    Object.defineProperty(pt, "Plugins", { enumerable: !0, configurable: !0, writable: !0, value: {} }));
  var vi = function (o, t) {
      let e = !0;
      return (...n) => {
        e &&
  ...
  var bn = (o) => {
    ...
    Bs = (o = {}) => Object.assign({ index: -1, slides: [], dim: 0, pos: -1 }, o),
    T = class extends yt {
      constructor(t, e) {
        (super(e),
    ...
    Be = class extends T {
      ...
      build() {
        let t = this.list;
        if (!t) {
          ((t = document.createElement("ul")), U(t, this.cn("list")), t.setAttribute("role", "tablist"));
          let e = this.instance.container;
          (e.appendChild(t), U(e, this.cn("hasDots")), (this.list = t));
        }
        return t;
      }
      refresh() {
        ...
        c && this.cleanup();
        let u = this.build();
        if ((nt(u, this.cn("isDynamic"), !!l), c)) for (let r = 0; r < e; r++) u.append(this.createItem(r));
        let g,
          s = 0;
        for (let r of [...u.children]) {
          let d = s === this.instance.page;
          (d && (g = r),
            nt(r, this.cn("isCurrent"), d),
            (t = r.children[0]) === null || t === void 0 || t.setAttribute("aria-selected", d ? "true" : "false"));
          for (let h of ["isBeforePrev", "isPrev", "isNext", "isAfterNext"]) M(r, this.cn(h));
          s++;
        }
        if (((g = g || u.firstChild), l && g)) {
          let r = g.previousElementSibling,
            d = r && r.previousElementSibling;
          (U(r, this.cn("isPrev")), U(d, this.cn("isBeforePrev")));
          let h = g.nextElementSibling,
            b = h && h.nextElementSibling;
          (U(h, this.cn("isNext")), U(b, this.cn("isAfterNext")));
        }
        this.isDynamic = l;
      }
      createItem(t = 0) {
        ...
        let i = et(this.instance.localize(this.option("dotTpl"), [["%d", t + 1]]).replace(/\%i/g, t + ""));
  ...
  Object.defineProperty(Be, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: Fs });
  var le = "disabled",
    ce = "next",
    yi = "prev",
    Fe = class extends T {
      ...
      onRefresh() {
        ...
        i &&
          ...
          t.isInfinite || (n <= 0 && i.setAttribute(le, ""), n >= e - 1 && a.setAttribute(le, "")));
      }
      addBtn(t) {
        var e;
        let n = this.instance,
        ...
        (i.setAttribute("tabindex", "0"),
          ...
          U(i, this.cn("button") + " " + this.cn(t === ce ? "isNext" : "isPrev")));
        let a = n.isRTL ? (t === ce ? yi : ce) : t;
        var l;
        return (
          (i.innerHTML = n.localize(this.option(`${a}Tpl`))),
          (i.dataset[
      ...
      build() {
        let t = this.instance.container,
          e = this.cn("container"),
          { container: n, prev: i, next: a } = this;
        (n || ((n = t.querySelector("." + e)), (this.isDom = !!n)),
          n || ((n = document.createElement("div")), U(n, e), t.appendChild(n)),
          (this.container = n),
          a || (a = n.querySelector("[data-carousel-next]")),
          a || (a = this.addBtn(ce)),
          (this.next = a),
  ...
  var ve = class extends T {
    ...
    attachEvents() {
      ...
      t &&
        ...
        t.state === N.Ready ? this.onNavReady(t) : t.on("ready", this.onNavReady),
        e.state === N.Ready ? this.onTargetReady(e) : e.on("ready", this.onTargetReady));
    }
    onNavReady(t) {
    ...
    onNavTouch(t, e, n) {
      ...
      let l = n.target,
        { nav: c, target: u } = this;
      if (!c || !u || !l) return;
      let g = l.closest("[data-index]");
      if ((n.stopPropagation(), n.preventDefault(), !g)) return;
      let s = parseInt(g.dataset.index || "", 10) || 0,
        r = u.getPageForSlide(s),
        d = c.getPageForSlide(s);
      (c.slideTo(d),
        u.slideTo(r, {
          friction:
            ((a = (i = this.nav) === null || i === void 0 ? void 0 : i.plugins) === null || a === void 0
              ? void 0
              : a.Sync.option("friction")) || 0,
        }),
    ...
    onTargetChange() {
      ...
      if (!n || !i || i.state !== N.Ready || n.state !== N.Ready) return;
      let a =
          (e = (t = n.pages[n.page]) === null || t === void 0 ? void 0 : t.slides[0]) === null || e === void 0
            ? void 0
            : e.index,
        l = i.getPageForSlide(a);
      (this.markSelectedSlide(a), i.slideTo(l, i.prevPage === null && n.prevPage === null ? { friction: 0 } : void 0));
    }
    markSelectedSlide(t) {
      let e = this.nav;
      e &&
    ...
    detach() {
      ...
      (e &&
        ...
        (t.nav = null),
        n && (n.off("ready", t.onTargetReady), n.off("refresh", t.onTargetChange), n.off("change", t.onTargetChange)),
        (t.target = null));
    }
  };
  ...
  var vs = { Navigation: Fe, Dots: Be, Sync: ve },
    de = "animationend",
    Ii = "isSelected",
    ue = "slide",
    Ut = class o extends Dt {
      get axis() {
      ...
      get isInfinite() {
        let t = !1,
          { contentDim: e, viewportDim: n, pages: i, slides: a } = this,
          l = a[0];
      ...
      processOptions() {
        var t, e;
        let n = S({}, o.defaults, this.userOptions),
          i = "",
          a = n.breakpoints;
        if (a && An(a))
          for (let [l, c] of Object.entries(a)) window.matchMedia(l).matches && An(c) && ((i += l), S(n, c));
        (i === this.bp && this.state !== N.Init) ||
          ((this.bp = i),
          this.state === N.Ready &&
            (n.initialSlide =
              ((e = (t = this.pages[this.page]) === null || t === void 0 ? void 0 : t.slides[0]) === null ||
              e === void 0
                ? void 0
                : e.index) || 0),
          this.state !== N.Init && this.destroy(),
          super.setOptions(n),
      ...
      initLayout() {
        ...
        (U(t, this.cn("container")),
          nt(t, e.isLTR, !this.isRTL),
          nt(t, e.isRTL, this.isRTL),
          nt(t, e.isVertical, !this.isHorizontal),
          nt(t, e.isHorizontal, this.isHorizontal));
        let n = this.option("viewport") || t.querySelector(`.${e.viewport}`);
        (n || ((n = document.createElement("div")), U(n, e.viewport), n.append(...Ui(t, `.${e.slide}`)), t.prepend(n)),
          n.addEventListener("scroll", this.onScroll));
        let i = this.option("track") || t.querySelector(`.${e.track}`);
        (i || ((i = document.createElement("div")), U(i, e.track), i.append(...Array.from(n.childNodes))),
      ...
      initSlides() {
        ...
        let e = [...this.slides],
          n = [];
        [...Ui(t, `.${this.cn(ue)}`)].forEach((i) => {
          if (k(i)) {
            let a = bn({ el: i, isDom: !0, index: this.slides.length });
            n.push(a);
          }
        });
        for (let i of [...(this.option("slides", []) || []), ...e]) n.push(bn(i));
        this.slides = n;
      ...
      setInitialPage() {
        ...
        this.page =
          typeof t == "number" ? this.getPageForSlide(t) : parseInt(this.option("initialPage", 0) + "", 10) || 0;
      }
      setInitialPosition() {
      ...
      createPages() {
        ...
        for (let u of this.slides)
          ((!t.length || l + u.dim - n > 0.05 || c >= i) && (t.push(Bs()), (a = t.length - 1), (l = 0), (c = 0)),
            t[a].slides.push(u),
            (l += u.dim + u.gap),
            c++);
        return t;
      ...
      processPages() {
        ...
        if (
          (t.forEach((s, r) => {
            ...
            for (let [h, b] of s.slides.entries()) ((s.dim += b.dim), h < s.slides.length - 1 && (s.dim += b.gap));
            c && s.pos + 0.5 * s.dim < 0.5 * n
              ? (s.pos = 0)
              : c && s.pos + 0.5 * s.dim >= e - 0.5 * n
                ? (s.pos = e - n)
                : a && (s.pos += -0.5 * (n - s.dim));
          }),
          t.forEach((s) => {
            (l && !i && e > n && ((s.pos = Math.max(s.pos, 0)), (s.pos = Math.min(s.pos, e - n))),
              (s.pos = B(s.pos, 1e3)),
              (s.dim = B(s.dim, 1e3)),
        ...
        return (
          t.forEach((s) => {
            ...
            g && r.pos === g.pos
              ? ((g.dim += r.dim), (g.slides = [...g.slides, ...r.slides]))
              : ((r.index = u.length), (g = r), u.push(r));
          }),
          u
        );
      }
      ...
      getSlideMetrics(t) {
        ...
        if (
          (c
            ? (a = parseFloat(c.dataset[i] || "") || 0)
            : ((c = document.createElement("div")),
              (c.style.visibility = "hidden"),
              (this.track || document.body).prepend(c)),
          U(c, this.cn(ue) + " " + t.class + " " + t.customClass),
          a)
        )
          ((c.style[i] = `${a}px`), (c.style[i === "width" ? "height" : "width"] = ""));
        else {
        ...
        let g = getComputedStyle(c);
        return (
          g.boxSizing === "content-box" &&
            (this.isHorizontal
              ? ((a += parseFloat(g.paddingLeft) || 0), (a += parseFloat(g.paddingRight) || 0))
              : ((a += parseFloat(g.paddingTop) || 0), (a += parseFloat(g.paddingBottom) || 0))),
          (l = parseFloat(g[this.isHorizontal ? "marginRight" : "marginBottom"]) || 0),
          u ? (n = c.parentElement) === null || n === void 0 || n.removeChild(c) : t.el || c.remove(),
          { dim: B(a, 1e3), gap: B(l, 1e3) }
        );
      }
      getBounds() {
        let { isInfinite: t, isRTL: e, isHorizontal: n, pages: i } = this,
          a = { min: 0, max: 0 };
        if (t) a = { min: -1 / 0, max: 1 / 0 };
        else if (i.length) {
          let l = i[0].pos,
            c = i[i.length - 1].pos;
          a = e && n ? { min: l, max: c } : { min: -1 * c, max: -1 * l };
        }
        return { x: n ? a : { min: 0, max: 0 }, y: n ? { min: 0, max: 0 } : a };
      }
      repositionSlides() {
        let t,
          {
          ...
          b = 0,
          m = 0;
        (r ? (m = -1 * r.current[this.axis]) : g[u] && (m = g[u].pos || 0),
          (t = e ? (n ? "right" : "left") : "top"),
          n && e && (m *= -1));
        for (let F of s) {
          let C = F.el;
          C
            ? (t === "top" ? ((C.style.right = ""), (C.style.left = "")) : (C.style.top = ""),
              F.index !== d ? (C.style[t] = h === 0 ? "" : `${B(h, 1e3)}px`) : (C.style[t] = ""),
              (b += F.dim + F.gap),
              d++)
            : (h += F.dim + F.gap);
        }
        if (i && b && a) {
          let F = getComputedStyle(a),
            C = "padding",
            I = e ? "Right" : "Bottom",
            w = parseFloat(F[C + (e ? "Left" : "Top")]);
          ((m -= w), (l += w), (l += parseFloat(F[C + I])));
          for (let y of s)
            y.el &&
              (B(y.pos) < B(l) &&
                B(y.pos + y.dim + y.gap) < B(m) &&
                B(m) > B(c - l) &&
                (y.el.style[t] = `${B(h + b, 1e3)}px`),
              B(y.pos + y.gap) >= B(c - l) &&
                B(y.pos) > B(m + l) &&
                B(m) < B(l) &&
                (y.el.style[t] = `-${B(b, 1e3)}px`));
        }
        let p,
          Q,
          f = [...this.inTransition];
        if ((f.length > 1 && ((p = g[f[0]]), (Q = g[f[1]])), p && Q)) {
          let F = 0;
          for (let C of s)
            C.el
              ? this.inTransition.has(C.index) &&
                p.slides.indexOf(C) < 0 &&
                (C.el.style[t] = `${B(F + (p.pos - Q.pos), 1e3)}px`)
              : (F += C.dim + C.gap);
        }
      }
      createSlideEl(t) {
        ...
        (U(i, this.cn(ue)), U(i, t.class), U(i, t.customClass));
        let a = t.html;
        ...
        let g = u && u.el && u.el.parentNode ? (u.index < t.index ? u.el.nextSibling : u.el) : null;
        (e.insertBefore(i, e.contains(g) ? g : null), (t.el = i), this.emit("createSlide", t));
      }
      removeSlideEl(t, e = !1) {
        let n = t?.el;
        if (!n || !n.parentNode) return;
        let i = this.cn(Ii);
        if ((n.classList.contains(i) && (M(n, i), this.emit("unselectSlide", t)), t.isDom && !e))
          return (n.removeAttribute("aria-hidden"), n.removeAttribute("data-index"), void (n.style.left = ""));
        this.emit("removeSlide", t);
        let a = new CustomEvent(de);
      ...
      transitionTo(t = 0, e = this.option("transition")) {
        ...
        if (
          ...
          u.length < 2 ||
          Math.abs(
            (((i = (n = u[c]) === null || n === void 0 ? void 0 : n.slides[0]) === null || i === void 0
              ? void 0
        ...
        if (c === s && Math.abs(d - g.target[this.axis]) < 1) return !1;
        this.clearTransitions();
        let h = g.isResting;
        U(this.container, this.cn("inTransition"));
        let b = ((a = u[c]) === null || a === void 0 ? void 0 : a.slides[0]) || null,
          m = ((l = u[s]) === null || l === void 0 ? void 0 : l.slides[0]) || null;
        (this.inTransition.add(m.index), this.createSlideEl(m));
        let p = b.el,
          Q = m.el;
        h || e === ue || ((e = "fadeFast"), (p = null));
        ...
        return (
          p &&
            ...
            (b.transition = e),
            p.addEventListener(de, this.onAnimationEnd),
            p.classList.add(`f-${e}Out`, `to-${r > 0 ? F : f}`)),
          Q &&
            ((m.transition = e),
            Q.addEventListener(de, this.onAnimationEnd),
            Q.classList.add(`f-${e}In`, `from-${r > 0 ? f : F}`)),
          (g.current[this.axis] = d),
          (g.target[this.axis] = d),
          g.requestTick(),
          this.onChange(s),
          !0
        );
            ...
            i &&
              ...
              i.classList.contains("f-thumbs__slide")
                ...
                : this.pages[this.page].slides.includes(n)
                  ? (i.classList.contains(e) || (U(i, e), this.emit("selectSlide", n)), i.removeAttribute(t))
                  : (i.classList.contains(e) && (M(i, e), this.emit("unselectSlide", n)), i.setAttribute(t, "true")));
          }
      }
      flipInfiniteTrack() {
        let { axis: t, isHorizontal: e, isInfinite: n, isRTL: i, viewportDim: a, contentDim: l } = this,
          c = this.panzoom;
        if (!c || !n) return;
        let u = c.current[t],
          g = c.target[t] - u,
        ...
        (i && e
          ...
          : (u > r && ((s = 1), (u -= l)), u < -l + r && ((s = -1), (u += l))),
          s && ((c.current[t] = u), (c.target[t] = u + g)));
      }
      lazyLoadImg(t, e) {
        let n = this,
          i = "f-fadeIn",
        ...
        (U(e, a),
          ...
          setTimeout(() => {
            let g = e.parentNode;
            g && t.el && (e.complete ? u() : l || ((c = et(On)), g.insertBefore(c, e)));
          }, 300));
      }
      lazyLoadSlide(t) {
        let e = t && t.el;
          ...
          i.map((a) => {
            a instanceof HTMLImageElement
              ...
              : a instanceof HTMLElement &&
                a.dataset.lazySrc &&
                ((a.style.backgroundImage = `url('${a.dataset.lazySrc}')`), delete a.dataset.lazySrc);
          }));
      ...
      onAnimationEnd(t) {
        ...
        (c && l.substring(0, c.length + 2) === `f-${c}` && this.inTransition.delete(i),
          ...
          i === this.page && !((e = this.panzoom) === null || e === void 0) && e.isResting && this.emit("settle"));
      }
      onDecel(t, e = 0, n = 0, i = 0, a = 0) {
        if (this.option("dragFree")) return void this.setPageFromPosition();
        let { isRTL: l, isHorizontal: c, axis: u, pages: g } = this,
          s = g.length,
        ...
        let h = this.page,
          b = l && c ? 1 : -1,
          m = t.current[u] * b,
          { pageIndex: p } = this.getPageFromPosition(m);
        (Math.abs(d) > 5
          ? (g[h].dim < document.documentElement["client" + (this.isHorizontal ? "Width" : "Height")] - 1 && (h = p),
            (h = l && c ? (d < 0 ? h - 1 : h + 1) : d < 0 ? h + 1 : h - 1))
          : (h = i === 0 && a === 0 ? h : p),
          this.slideTo(h, { transition: !1, friction: t.option("decelFriction") }));
      }
      onClick(t) {
        let e = t.target,
          n = e && k(e) ? e.dataset : null,
          i,
          a;
        (n &&
          (n.carouselPage !== void 0
            ? ((a = "slideTo"), (i = n.carouselPage))
            : n.carouselNext !== void 0
              ? (a = "slideNext")
              : n.carouselPrev !== void 0 && (a = "slidePrev")),
          a
            ? (t.preventDefault(), t.stopPropagation(), e && !e.hasAttribute("disabled") && this[a](i))
            : this.emit("click", t));
      }
      onSlideTo(t) {
        let e = t.detail || 0;
      ...
      slideTo(t = 0, { friction: e = this.option("friction"), transition: n = this.option("transition") } = {}) {
        ...
        let i = this.getPageFromIndex(t),
          { axis: a, isHorizontal: l, isRTL: c, pages: u, panzoom: g } = this,
          s = u.length,
          r = c && l ? 1 : -1;
        if (!g || !s) return;
        if (this.page !== i) {
        ...
        if (this.isInfinite) {
          ...
          s === 2
            ...
            : (d = [d, d - h, d + h].reduce(function (m, p) {
                return Math.abs(p - b) < Math.abs(m - b) ? p : m;
              }));
        }
        ((d *= r),
          Math.abs(g.target[a] - d) < 1 || (g.panTo({ x: l ? d : 0, y: l ? 0 : d, friction: e }), this.onChange(i)));
      }
      slideToClosest(t) {
        if (this.panzoom) {
      ...
      clearTransitions() {
        ...
        for (let e of this.slides) {
          let n = e.el;
          if (n) {
            (n.removeEventListener(de, this.onAnimationEnd), n.classList.remove(...t));
            let i = e.transition;
      ...
      addSlide(t, e) {
        ...
        let c = this.panzoom,
          ...
          g = ((i = this.pages[this.page]) === null || i === void 0 ? void 0 : i.dim) || 0,
          s = this.contentDim < this.viewportDim,
          r = Array.isArray(e) ? e : [e],
          d = [];
        for (let h of r) d.push(bn(h));
        ...
        if ((this.page >= t && (this.page += d.length), this.updateMetrics(), c)) {
          let h = ((a = this.pages[this.page]) === null || a === void 0 ? void 0 : a.pos) || 0,
            b = ((l = this.pages[this.page]) === null || l === void 0 ? void 0 : l.dim) || 0,
            m = this.pages.length || 1,
            p = this.isRTL ? g - b : b - g,
            Q = this.isRTL ? u - h : h - u;
          s && m === 1
            ? (t <= this.page && ((c.current[this.axis] -= p), (c.target[this.axis] -= p)),
              c.panTo({ [this.isHorizontal ? "x" : "y"]: -1 * h }))
            : Q && t <= this.page && ((c.target[this.axis] -= Q), (c.current[this.axis] -= Q), c.requestTick());
        }
      ...
      updateMetrics() {
        let { panzoom: t, viewport: e, track: n, slides: i, isHorizontal: a, isInfinite: l } = this;
        if (!n) return;
        let c = a ? "width" : "height",
          u = a ? "offsetWidth" : "offsetHeight";
        if (e) {
          let r = Math.max(e[u], B(e.getBoundingClientRect()[c], 1e3)),
            d = getComputedStyle(e),
            h = "padding",
            b = a ? "Right" : "Bottom";
          ((r -= parseFloat(d[h + (a ? "Left" : "Top")]) + parseFloat(d[h + b])), (this.viewportDim = r));
        }
        let g,
          s = 0;
        for (let [r, d] of i.entries()) {
          let h = 0,
            b = 0;
          (!d.el && g ? ((h = g.dim), (b = g.gap)) : (({ dim: h, gap: b } = this.getSlideMetrics(d)), (g = d)),
            (h = B(h, 1e3)),
            (b = B(b, 1e3)),
            (d.dim = h),
            (d.gap = b),
        ...
        ((s = B(s, 1e3)),
          (this.contentDim = s),
          t && ((t.contentRect[c] = s), (t.contentRect[a ? "fullWidth" : "fullHeight"] = s)),
          (this.pages = this.createPages()),
          (this.pages = this.processPages()),
          this.state === N.Init && this.setInitialPage(),
      ...
      getProgress(t, e = !1, n = !1) {
        ...
        let u = -1 * a.current.e,
          g = B((u - c.pos) / (1 * c.dim), 1e3),
          s = g,
          r = g;
        this.isInfinite &&
          n !== !0 &&
          ((s = B((u - c.pos + l) / (1 * c.dim), 1e3)), (r = B((u - c.pos - l) / (1 * c.dim), 1e3)));
        let d = [g, s, r].reduce(function (h, b) {
      ...
      getVisibleSlides(t = 0) {
        var e;
        let n = new Set(),
          { panzoom: i, contentDim: a, viewportDim: l, pages: c, page: u } = this;
        if (l) {
          a = a + ((e = this.slides[this.slides.length - 1]) === null || e === void 0 ? void 0 : e.gap) || 0;
          let g = 0;
          ((g = i && i.state !== O.Init && i.state !== O.Destroy ? -1 * i.current[this.axis] : (c[u] && c[u].pos) || 0),
            this.isInfinite && (g -= Math.floor(g / a) * a),
            this.isRTL && this.isHorizontal && (g *= -1));
          let s = g - l * t,
            r = g + l * (t + 1),
      ...
      getPageFromPosition(t) {
        let { viewportDim: e, contentDim: n, slides: i, pages: a, panzoom: l } = this,
          c = a.length,
          u = i.length,
          g = i[0],
          s = i[u - 1],
          ...
          h = 0,
          b = 0,
          m = t === void 0 ? -1 * (l?.target[this.axis] || 0) : t;
        (r && (m += 0.5 * e),
          this.isInfinite
            ? (m < g.pos - 0.5 * s.gap && ((m -= n), (b = -1)), m > s.pos + s.dim + 0.5 * s.gap && ((m -= n), (b = 1)))
            : (m = Math.max(g.pos || 0, Math.min(m, s.pos))));
        let p = s,
          Q = i.find((f) => {
            let F = f.pos - 0.5 * p.gap,
              C = f.pos + f.dim + 0.5 * f.gap;
            return ((p = f), m >= F && m < C);
          });
        return (Q || (Q = s), (h = this.getPageForSlide(Q.index)), (d = h + b * c), { page: d, pageIndex: h });
      }
      setPageFromPosition() {
      ...
      destroy() {
        ...
        for (let [u, g] of Object.entries(l)) u !== "container" && g && t.classList.remove(g);
        ((this.track = null), (this.viewport = null), (this.page = 0), (this.slides = []));
        let c = this.events.get("ready");
        ((this.events = new Map()), c && this.events.set("ready", c));
      }
    };
  (Object.defineProperty(Ut, "Panzoom", { enumerable: !0, configurable: !0, writable: !0, value: pt }),
    Object.defineProperty(Ut, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: fs }),
    Object.defineProperty(Ut, "Plugins", { enumerable: !0, configurable: !0, writable: !0, value: vs }));
  var zi = function (o) {
      if (!k(o)) return 0;
    ...
    Wn = {
      ...
      l10n: Object.assign(Object.assign({}, Ti), {
        CLOSE: "Close",
        NEXT: "Next",
        PREV: "Previous",
  ...
  var xi = "",
      ...
      if (e) {
        ...
        if (n && i) {
          ...
          ((t = a || e.option("slug") || ""),
            ...
            t && t !== "true" && (o = "#" + t + (!a && n.slides.length > 1 ? "-" + (i.index + 1) : "")));
        }
      }
    ...
    Hi = () => {
      let { slug: o, index: t } = Ue();
      if (!o) return;
      let e = document.querySelector(`[data-slug="${o}"]`);
      if ((e && e.dispatchEvent(new CustomEvent("click", { bubbles: !0, cancelable: !0 })), P.getInstance())) return;
      let n = document.querySelectorAll(`[data-fancybox="${o}"]`);
      n.length && ((e = n[t - 1]), e && e.dispatchEvent(new CustomEvent("click", { bubbles: !0, cancelable: !0 })));
    },
    Ki = () => {
      if (P.defaults.Hash === !1) return;
      let o = P.getInstance();
      if (o?.options.Hash === !1) return;
      let { slug: t, index: e } = Ue(),
        { slug: n } = Ji();
      (o && (t === n ? o.jumpTo(e - 1) : ((Ot = !0), o.close())), Hi());
    },
    Pi = () => {
      (bt && clearTimeout(bt),
        queueMicrotask(() => {
    ...
    wi = () => {
      (window.addEventListener("hashchange", Pi, !1),
        setTimeout(() => {
          Ki();
        }, 500));
    };
  ...
  var ge = "is-zooming-in",
    ye = class extends T {
      ...
      onChange(t, e, n, i) {
        M(this.instance.container, ge);
        for (let a of e.slides) {
          let l = a.panzoom;
          l && a.index !== n && l.reset(0.35);
        }
      }
      onClose() {
        var t;
        ...
        let { el: a, contentEl: l, panzoom: c, thumbElSrc: u } = i;
        if (!a || !u || !l || !c || c.isContentLoading || c.state === O.Init || c.state === O.Destroy) return;
        c.updateMetrics();
        let g = this.getZoomInfo(i);
        if (!g) return;
        ...
        let { x: r, y: d, scale: h, opacity: b } = g;
        if (b) {
          let m = ((p, Q, f, F) => {
            let C = Q - p,
              I = F - f;
            return (w) => f + (((w - p) / C) * I || 0);
          })(c.scale, h, 1, 0);
          c.on("afterTransform", () => {
            l.style.opacity = m(c.scale) + "";
          });
        }
        (c.on("endAnimation", () => {
          e.destroy();
          ...
          (c.target.c = 0),
          (c.target.d = h),
          c.panTo({ x: r, y: d, scale: h, friction: b ? 0.2 : 0.33, ignoreBounds: !0 }),
      ...
      setImage(t, e) {
        ...
        ((t.src = e),
          this.process(t, e).then(
            (i) => {
              let { contentEl: a, imageEl: l, thumbElSrc: c, el: u } = t;
              if (n.isClosing() || !a || !l) return;
              a.offsetHeight;
              let g = !!n.isOpeningSlide(t) && this.getZoomInfo(t);
              if (this.option("protected") && u) {
                u.addEventListener("contextmenu", (d) => {
                  d.preventDefault();
                });
                let r = document.createElement("div");
                (U(r, "fancybox-protected"), a.appendChild(r));
              }
              if (c && g) {
                let r = i.contentRect,
                ...
                !g.opacity &&
                  d > 1200 &&
                  ((h = document.createElement("img")), U(h, "fancybox-ghost"), (h.src = c), a.appendChild(h));
                let b = () => {
                  h &&
                    (U(h, "f-fadeFastOut"),
                    setTimeout(() => {
                ...
                new Promise((m, p) => {
                  let Q = new Image();
                  ((Q.onload = m), (Q.onerror = p), (Q.src = s));
                })).then(
                  () => {
                    (n.hideLoading(t),
                      (t.state = V.Opening),
                ...
                let r = this.optionFor(t, "initialSize"),
                  ...
                  h = { event: n.prevMouseMoveEvent || n.options.event, friction: d ? 0.12 : 0 },
                  b = n.optionFor(t, "showClass") || void 0,
                  m = !0;
                (n.isOpeningSlide(t) &&
                  (r === "full"
                    ? i.zoomToFull(h)
      ...
      process(t, e) {
        return new Promise((n, i) => {
          ...
          if ((typeof u == "string" && (u = et(u)), !u || !k(u))) {
            if (((u = document.createElement("img")), u instanceof HTMLImageElement)) {
              ...
              ((g =
                typeof s == "string" && s
                  ...
                  : `Image ${t.index + 1} of ${((a = l.carousel) === null || a === void 0 ? void 0 : a.pages.length) || 1}`),
                (u.src = e || ""),
                (u.alt = g),
                (u.draggable = !1),
          ...
          (U(u, "fancybox-image"),
            ...
            (t.panzoom = new pt(
              c,
              S({ transformParent: !0 }, this.option("Panzoom") || {}, {
                content: u,
                width: (g, s) => l.optionFor(t, "width", "auto", s) || "auto",
                height: (g, s) => l.optionFor(t, "height", "auto", s) || "auto",
                wheel: () => {
                  let g = l.option("wheel");
                ...
                click: (g, s) => {
                  ...
                  if (
                    ...
                    return !1;
                  if (s) {
                    let b = s.composedPath()[0];
                    if (["A", "BUTTON", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].includes(b.nodeName))
                      return !1;
                  }
                  let h =
                    !s || (s.target && ((d = t.contentEl) === null || d === void 0 ? void 0 : d.contains(s.target)));
      ...
      zoomIn(t) {
        return new Promise((e, n) => {
          ...
          if (!(g && u && c && l && a)) return void n();
          let { x: s, y: r, scale: d, opacity: h } = g,
            b = () => {
              t.state !== V.Closing &&
                (h && (c.style.opacity = Math.max(Math.min(1, 1 - (1 - l.scale) / (1 - d)), 0) + ""),
          ...
          (l.on("endAnimation", m),
            l.on("touchStart", m),
            l.on("afterTransform", b),
            l.on(["error", "destroy"], () => {
              n();
            }),
            l.panTo({ x: s, y: r, scale: d, friction: 0, ignoreBounds: !0 }),
            l.stop("current"));
          let p = { event: l.panMode === "mousemove" ? i.prevMouseMoveEvent || i.options.event : void 0 },
            Q = this.optionFor(t, "initialSize");
          (U(a, ge),
            i.hideLoading(t),
            Q === "full"
              ? l.zoomToFull(p)
      ...
      getZoomInfo(t) {
        let { el: e, imageEl: n, thumbEl: i, panzoom: a } = t,
          l = this.instance,
          c = l.container;
        if (
          !e ||
        ...
        let { top: g, left: s, width: r, height: d } = i.getBoundingClientRect(),
          { top: h, left: b, fitWidth: m, fitHeight: p } = a.contentRect;
        if (!(r && d && m && p)) return !1;
        let Q = a.container.getBoundingClientRect();
        ((b += Q.left), (h += Q.top));
        let f = -1 * (b + 0.5 * m - (s + 0.5 * r)),
          F = -1 * (h + 0.5 * p - (g + 0.5 * d)),
          C = r / m,
          I = this.option("zoomOpacity") || !1;
        return (I === "auto" && (I = Math.abs(r / d - m / p) > 0.1), { x: f, y: F, scale: C, opacity: I });
      }
      attach() {
        let t = this,
          e = t.instance;
  ...
  <source src="{{src}}" type="{{format}}" />Sorry, your browser doesn't support embedded videos.</video>`,
    ...
    ys = ["image", "html", "ajax", "inline", "clone", "iframe", "map", "pdf", "html5video", "youtube", "vimeo"],
    Ie = class extends T {
      ...
      onSelectSlide(t, e, n) {
        n.state === V.Ready && this.playVideo();
      }
      onUnselectSlide(t, e, n) {
        var i, a;
        if (n.type === Wt) {
          try {
            (a = (i = n.el) === null || i === void 0 ? void 0 : i.querySelector("video")) === null ||
              a === void 0 ||
              a.pause();
          } catch {}
          return;
        ...
        (n.type === ut
          ...
          : n.type === st && (l = { event: "command", func: "pauseVideo" }),
          l && n.iframeEl && n.iframeEl.contentWindow && n.iframeEl.contentWindow.postMessage(JSON.stringify(l), "*"),
      ...
      resizeIframe(t) {
        ...
        l && c && (a = !1);
        let u = i && i.style;
        if (t.preload !== !1 && a !== !1 && u)
          try {
            let g = window.getComputedStyle(i),
              s = parseFloat(g.paddingLeft) + parseFloat(g.paddingRight),
              r = parseFloat(g.paddingTop) + parseFloat(g.paddingBottom),
              d = n.contentWindow;
            if (d) {
              let h = d.document,
                b = h.getElementsByTagName(Qn)[0],
                m = h.body;
              ((u.width = ""),
                ...
                (m.style.overflow = ""),
                (u.flex = "0 0 auto"),
                (u.height = `${m.scrollHeight}px`),
                (c = b.scrollHeight + r));
            }
          } catch {}
        if (l || c) {
          let g = { flex: "0 1 auto", width: "", height: "" };
          (l && l !== "auto" && (g.width = `${l}px`), c && c !== "auto" && (g.height = `${c}px`), Object.assign(u, g));
        }
      }
      playVideo() {
        ...
        let n = () => {
          if (t.iframeEl && t.iframeEl.contentWindow) {
            ...
            if (t.iframeEl.dataset.ready === "true")
              return (
                (i = t.type === st ? { event: "command", func: "playVideo" } : { method: "play", value: "true" }),
      ...
      processType(t) {
        if (t.html) return ((t.type = Qn), (t.src = t.html), void (t.html = ""));
        let e = this.instance.optionFor(t, "src", "");
        ...
        if (
          ...
          let a = this.optionFor(t, st),
            ...
            c = (function (r, d) {
              var h = {};
              for (var b in r) Object.prototype.hasOwnProperty.call(r, b) && d.indexOf(b) < 0 && (h[b] = r[b]);
              if (r != null && typeof Object.getOwnPropertySymbols == "function") {
                var m = 0;
                for (b = Object.getOwnPropertySymbols(r); m < b.length; m++)
                  d.indexOf(b[m]) < 0 && Object.prototype.propertyIsEnumerable.call(r, b[m]) && (h[b[m]] = r[b[m]]);
              }
              return h;
            })(a, ["nocookie"]),
        ...
        (n ||
          (typeof e == "string" &&
            (e.charAt(0) === "#"
              ...
              : (i = e.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i))
                ? ((n = Wt), (t.videoFormat = t.videoFormat || "video/" + (i[1] === "ogv" ? "ogg" : i[1])))
          ...
          (i = e.match(
            ...
            ? ((t.src = `https://maps.google.${i[1]}/?ll=${(i[2] ? i[2] + "&z=" + Math.floor(parseFloat(i[3])) + (i[4] ? i[4].replace(/^\//, "&") : "") : i[4] + "").replace(/\?/, "&")}&output=${i[4] && i[4].indexOf("layer=c") > 0 ? "svembed" : "embed"}`),
              (n = fn))
            : (i = e.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:maps\/search\/)(.*)/i)) &&
              ((t.src = `https://maps.google.${i[1]}/maps?q=${i[2].replace("query=", "q=").replace("api=1", "")}&output=embed`),
              (n = fn)),
          (n = n || this.instance.option("defaultType")),
          (t.type = n),
          n === Li && (t.thumbSrc = t.thumbSrc || t.src));
      }
      setContent(t) {
        let e = this.instance.optionFor(t, "src") || "";
        if (t && t.type && e) {
      ...
      setAspectRatio(t) {
        let e = t.contentEl;
        if (!(t.el && e && t.type && [st, ut, Wt].includes(t.type))) return;
        let n,
          i = t.width || "auto",
          a = t.height || "auto";
        if (i === "auto" || a === "auto") {
          n = this.optionFor(t, "videoRatio");
          let g = (n + "").match(/(\d+)\s*\/\s?(\d+)/);
          n = g && g.length > 2 ? parseFloat(g[1]) / parseFloat(g[2]) : parseFloat(n + "");
        } else i && a && (n = i / a);
        if (!n) return;
        ...
        ((e.style.aspectRatio = n + ""),
          n < c / u
            ? ((a = a === "auto" ? u : Math.min(u, a)), (e.style.width = "auto"), (e.style.height = `${a}px`))
            : ((i = i === "auto" ? c : Math.min(c, i)), (e.style.width = `${i}px`), (e.style.height = "auto")));
      }
      attach() {
        let t = this,
          e = t.instance;
  ...
  Object.defineProperty(Ie, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: Us });
  var be = "play",
    me = "pause",
    Mt = "ready",
    Ce = class extends T {
      constructor() {
        (super(...arguments),
          Object.defineProperty(this, "state", { enumerable: !0, configurable: !0, writable: !0, value: Mt }),
      ...
      createProgressBar() {
        ...
        return (U(a, "f-progress"), i.prepend(a), (this.progressBar = a), a.offsetHeight, a);
      }
      set() {
        let t = this,
          e = t.instance;
        ...
        ((t.state = be), U(e.container, "has-autoplay"));
      ...
      stop() {
        ...
        (t.clear(),
          (t.state = Mt),
          n.removeEventListener("mouseenter", t.onMouseEnter, !1),
          n.removeEventListener("mouseleave", t.onMouseLeave, !1),
      ...
      pause() {
        let t = this;
        t.state === be && ((t.state = me), t.clear(), t.emit(me));
      }
      resume() {
        let t = this,
          e = t.instance;
        if (e.isInfinite || e.page !== e.pages.length - 1)
          if (t.state !== be) {
            if (t.state === me && !t.inHover) {
              let n = new Event("resume", { bubbles: !0, cancelable: !0 });
      ...
      toggle() {
        this.state === be || this.state === me ? this.stop() : this.start();
      }
      attach() {
        let t = this,
          e = t.instance;
  ...
  var xe = class extends T {
    ...
    onPrepare(t) {
      ...
      let n = t.container;
      n &&
        ((e.options.Autoplay = S({ autoStart: !1 }, this.option("Autoplay") || {}, {
          pauseOnHover: !1,
          ...
          on: {
            ...
            set: (i) => {
              ...
              (n.classList.add("has-slideshow"),
                ((a = t.getSlide()) === null || a === void 0 ? void 0 : a.state) !== V.Ready && i.pause());
            },
            stop: () => {
            ...
            resume: (i, a) => {
              ...
              !a ||
                !a.cancelable ||
                (((l = t.getSlide()) === null || l === void 0 ? void 0 : l.state) === V.Ready &&
                  !((u = (c = t.carousel) === null || c === void 0 ? void 0 : c.panzoom) === null || u === void 0) &&
                  u.isResting) ||
                a.preventDefault();
            },
          },
        })),
        e.attachPlugins({ Autoplay: Ce }),
      ...
      progressParentEl: (o) => {
        ...
        return (
          ((t = o.instance.container) === null || t === void 0
            ? void 0
            : t.querySelector(".fancybox__toolbar [data-fancybox-toggle-slideshow]")) || o.instance.container
        );
      },
      timeout: 3e3,
    },
    ...
    qi = class extends T {
      ...
      onInitSlide(o, t) {
        ...
        (e &&
          ...
          (t[tt] = parseFloat(e[tt] || "") || t[tt] || 0),
          (t[ft] = parseFloat(e.thumbHeight || "") || t[ft] || 0)),
          this.addSlide(t));
      }
      onInitSlides() {
        this.build();
      ...
      onChange() {
        ...
        if (n && i && a) {
          if (n.isDragging) {
            ...
            c += e.getProgress(l) * (this[tt] + this.thumbGap);
            let u = a.getBounds();
            -1 * c > u.x.min && -1 * c < u.x.max && a.panTo({ x: -1 * c, friction: 0.12 });
          } else nt(t, this.cn(Wi), n.isResting);
          this.shiftModern();
        }
      }
      onRefresh() {
      ...
      resizeModernSlide(o) {
        this.isModern && (o[pe] = o[tt] && o[ft] ? Math.round(this[ft] * (o[tt] / o[ft])) : this[pe]);
      }
      updateProps() {
      ...
      build() {
        ...
        let a = o.option("parentEl"),
          ...
          c = o.cn("track"),
          u = a?.querySelector("." + l);
        (u || ((u = document.createElement("div")), U(u, l), a ? a.appendChild(u) : e.after(u)),
          U(u, `is-${i}`),
          U(e, o.cn("hasThumbs")),
          (o.container = u),
          o.updateProps());
        let g = u.querySelector("." + c);
        (g || ((g = document.createElement("div")), U(g, o.cn("track")), u.appendChild(g)), (o.track = g));
        let s = S(
            {},
            {
              track: g,
      ...
      onClick(o) {
        ...
        let t = this.instance,
          ...
          i = (m) => {
            if (m) {
              let p = m.closest("[data-carousel-index]");
              if (p) return [parseInt(p.dataset.carouselIndex || "", 10) || 0, p];
            }
            return [-1, void 0];
          },
          a = (m, p) => {
            let Q = document.elementFromPoint(m, p);
            return Q ? i(Q) : [-1, void 0];
          },
          [l, c] = i(o.target);
        if (l > -1) return;
        let u = this[tt],
          ...
          [h, b] = a(g + u, s);
        (d && b
          ? ((l = Math.abs(g - d.getBoundingClientRect().right) < Math.abs(g - b.getBoundingClientRect().left) ? r : h),
            l === n && (l = l === r ? h : r))
          : d
            ? (l = r)
            : b && (l = h),
      ...
      getShift(o) {
        ...
        return (
          o === 0
            ? ((b = m * Math.abs(r)), Q && r === 1 && (b -= m * Math.abs(d)))
            : o === s
              ? ((b = m * Math.abs(d) * -1), p && d === -1 && (b += m * Math.abs(r)))
              : p || Q
                ? ((b = -1 * m), (b += m * Math.abs(r)), (b += m * (1 - Math.abs(d))))
                : (b = m * h),
          b
        );
      }
      ...
      shiftModern() {
        ...
        let a = (o[tt] + o.thumbGap) * (i.slides.length || 0);
      ...
      cleanup() {
        ...
        (o.carousel && o.carousel.destroy(),
          ...
          (o.track = null),
          (o.state = at.Init),
          M(o.instance.container, o.cn("hasThumbs")));
      }
      attach() {
        let o = this,
          t = o.instance;
        (t.on("initSlide", o.onInitSlide),
          t.state === N.Init ? t.on("initSlides", o.onInitSlides) : o.onInitSlides(),
  ...
  Object.defineProperty(qi, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: $i });
  var Is = Object.assign(Object.assign({}, $i), { key: "t", showOnStart: !0, parentEl: null }),
    Mi = "is-masked",
    Oi = "aria-hidden",
    we = class extends T {
      constructor() {
      ...
      onCreateSlide(t, e) {
        ...
        let l =
            ((a =
              (i = (n = this.instance) === null || n === void 0 ? void 0 : n.carousel) === null || i === void 0
                ? void 0
                : i.slides[e.index]) === null || a === void 0
              ? void 0
              : a.type) || "",
          c = e.el;
        if (c && l) {
          let u = `for-${l}`;
          (["video", "youtube", "vimeo", "html5video"].includes(l) && (u += " for-video"), U(c, u));
        }
      }
      onInit() {
        var t;
        ...
        ((l.Carousel = l.Carousel || {}),
          (l.Carousel.on = S(((t = e.options.Carousel) === null || t === void 0 ? void 0 : t.on) || {}, {
            click: this.onClick,
            createSlide: this.onCreateSlide,
          })),
          (i.options.Thumbs = l),
          i.attachPlugins({ Thumbs: qi }),
          (e.ref = i.plugins.Thumbs),
          e.option("showOnStart") || ((e.ref.state = at.Hidden), (e.hidden = !0)));
      }
      onResize() {
        var t;
      ...
      show() {
        ...
        let e = t.container;
        e && (this.refresh(), e.offsetHeight, e.removeAttribute(Oi), e.classList.remove(Mi), (this.hidden = !1));
      }
      hide() {
        let t = this.ref,
          e = t && t.container;
        (e && (this.refresh(), e.offsetHeight, e.classList.add(Mi), e.setAttribute(Oi, "true")), (this.hidden = !0));
      }
      refresh() {
        let t = this.ref;
        if (!t || !t.state) return;
      ...
      attach() {
        let t = this,
          e = t.instance;
        (e.state === j.Init ? e.on("Carousel.init", t.onInit) : t.onInit(),
  ...
  Object.defineProperty(we, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: Is });
  var Bn = {
  ...
  var Cs = {
    ...
    xs = { tabindex: "-1", width: "24", height: "24", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" },
    Gi = "has-toolbar",
    Fn = "fancybox__toolbar",
    Le = class extends T {
      constructor() {
        (super(...arguments),
          Object.defineProperty(this, "state", {
      ...
      onReady(t) {
        ...
        if (a === "auto") {
          let g = this.instance.carousel,
            s = 0;
          if (g) for (let r of g.slides) (r.panzoom || r.type === "image") && s++;
          s || (a = !1);
        }
        a || (n = void 0);
        let l = 0,
          c = { left: [], middle: [], right: [] };
        if (n)
          for (let g of ["left", "middle", "right"])
            for (let s of n[g]) {
              let r = this.createEl(s);
              r && ((e = c[g]) === null || e === void 0 || e.push(r), l++);
            }
        let u = null;
        if ((l && (u = this.createContainer()), u)) {
          for (let [g, s] of Object.entries(c)) {
            let r = document.createElement("div");
            U(r, Fn + "__column is-" + g);
            for (let d of s) r.appendChild(d);
            (i !== "auto" || g !== "middle" || s.length || (i = !0), u.appendChild(r));
          }
          (i === !0 && U(u, "is-absolute"), (this.state = mt.Ready), this.onRefresh());
        } else this.state = mt.Disabled;
      }
      onClick(t) {
        var e, n;
        let i = this.instance,
        ...
        let g = u.panzoomAction,
          s = u.panzoomChange;
        if (((s || g) && (t.preventDefault(), t.stopPropagation()), s)) {
          let r = {};
          try {
            r = JSON.parse(s);
          } catch {}
      ...
      createContainer() {
        ...
        return (
          n || ((n = document.createElement("div")), U(n, Fn), e.prepend(n)),
      ...
      createEl(t) {
        let e = this.instance,
          n = e.carousel;
        if (!n || t === "toggleFS" || (t === "fullscreen" && !_i())) return null;
        let i = null,
          a = n.slides.length || 0,
          l = 0,
          c = 0;
        for (let g of n.slides)
          ((g.panzoom || g.type === "image") && l++, (g.type === "image" || g.downloadSrc) && c++);
        if (a < 2 && ["infobar", "prev", "next"].includes(t)) return i;
        if ((Bn[t] !== void 0 && !l) || (t === "download" && !c)) return null;
        if (t === "thumbs") {
          let g = e.plugins.Thumbs;
        ...
        if (Bn[t] !== void 0) {
          ...
          ((i = document.createElement("button")),
            ...
            U(i, "f-button"),
            g.action && (i.dataset.panzoomAction = g.action),
            g.change && (i.dataset.panzoomChange = JSON.stringify(g.change)),
            i.appendChild(et(this.instance.localize(g.icon))));
        } else {
          let g = (this.option("items") || [])[t];
          g &&
            ((i = et(this.instance.localize(g.tpl))),
            typeof g.click == "function" &&
              i.addEventListener("click", (s) => {
                (s.preventDefault(), s.stopPropagation(), typeof g.click == "function" && g.click.call(this, this, s));
              }));
        }
        let u = i?.querySelector("svg");
        if (u) for (let [g, s] of Object.entries(xs)) u.getAttribute(g) || u.setAttribute(g, String(s));
        return i;
      }
      removeContainer() {
        let t = this.container;
        (t && t.remove(), (this.container = null), (this.state = mt.Disabled));
        let e = this.instance.container;
        e && M(e, Gi);
      }
      attach() {
  ...
  Object.defineProperty(Le, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: Cs });
  var ws = {
      Hash: class extends T {
        onReady() {
          Ot = !1;
        }
        onChange(o) {
            ...
            t &&
              ...
              (bt = setTimeout(() => {
                try {
                  if (o.state === j.Ready) {
                    let i = "replaceState";
                    (n && !he && ((i = "pushState"), (he = !0)),
                      window.history[i]({}, document.title, window.location.pathname + window.location.search + t));
                  }
                } catch {}
              }, 300)));
        }
        onClose(o) {
          if ((bt && clearTimeout(bt), !Ot && he)) return ((he = !1), (Ot = !1), void window.history.back());
          if (!Ot)
            try {
              window.history.replaceState(
                {},
                document.title,
                window.location.pathname + window.location.search + (xi || ""),
              );
            } catch {}
        }
        attach() {
        ...
        static destroy() {
          window.removeEventListener("hashchange", Pi, !1);
        }
      },
      Html: Ie,
      Images: ye,
    ...
    P = class o extends Dt {
      ...
      init() {
        ...
        let t = () => {
          (this.initCarousel(this.userSlides),
            ...
            this.emit("ready"),
            setTimeout(() => {
              this.container && this.container.setAttribute(Un, "false");
            }, 16));
        };
        this.option("Fullscreen.autoStart") && H && !H.isFullscreen()
          ? H.request()
              .then(() => {
                ((this.startedFs = !0), t());
              })
      ...
      initLayout() {
        ...
        let n = this.option("parentEl") || document.body,
          i = et(this.localize(this.option("tpl.main") || ""));
        if (i) {
          if (
            (i.setAttribute("id", `fancybox-${this.id}`),
            i.setAttribute("aria-label", this.localize("{{MODAL}}")),
            i.classList.toggle(Ei, this.isCompact),
            U(i, this.option("mainClass") || ""),
            U(i, Cn),
            (this.container = i),
            (this.footer = i.querySelector(".fancybox__footer")),
            n.appendChild(i),
            U(document.documentElement, Di),
            (K && gt) ||
              ((K = document.createElement("span")),
              U(K, "fancybox-focus-guard"),
              K.setAttribute(ht, "0"),
              K.setAttribute(Un, "true"),
              K.setAttribute("aria-label", "Focus guard"),
              (gt = K.cloneNode()),
              (t = i.parentElement) === null || t === void 0 || t.insertBefore(K, i),
              (e = i.parentElement) === null || e === void 0 || e.append(gt)),
            i.addEventListener("mousedown", (a) => {
              ((Vi = a.pageX), (ki = a.pageY), M(i, yn));
            }),
            this.option("closeExisting"))
          )
            for (let a of vt.values()) a.id !== this.id && a.close();
          else
            this.option("animated") &&
              (U(i, In),
              setTimeout(() => {
                this.isClosing() || M(i, In);
              }, 350));
          this.emit("initLayout");
        }
      }
      initCarousel(t) {
        ...
        (i.on("*", (a, l, ...c) => {
          ...
          this.option("dragToClose") &&
            (i.on("Panzoom.afterTransform", (a, l) => {
              let c = this.getSlide();
              if (c && wn(c.el)) return;
              let u = this.container;
              if (u) {
                let g = Math.abs(l.current.f),
                  s = g < 1 ? "" : Math.max(0.5, Math.min(1, 1 - (g / l.contentRect.fitHeight) * 1.5));
              ...
              if (
                ...
                (l.isMobile &&
                  ...
                  ["TEXTAREA", "INPUT"].indexOf(
                    (u = document.activeElement) === null || u === void 0 ? void 0 : u.nodeName,
                  ) !== -1)
              )
                return;
          ...
          i.on("change", (a) => {
            ...
            if (c) {
              let u = new CustomEvent("slideTo", { bubbles: !0, cancelable: !0, detail: a.page });
              c.dispatchEvent(u);
            }
          }),
          i.on(["refresh", "change"], (a) => {
            ...
            if (!l) return;
            for (let g of l.querySelectorAll("[data-fancybox-current-index]")) g.innerHTML = a.page + 1;
            for (let g of l.querySelectorAll("[data-fancybox-count]")) g.innerHTML = a.pages.length;
            if (!a.isInfinite) {
              for (let g of l.querySelectorAll("[data-fancybox-next]"))
                a.page < a.pages.length - 1
                  ? (g.removeAttribute(Bt), g.removeAttribute(ht))
                  : (g.setAttribute(Bt, ""), g.setAttribute(ht, "-1"));
              for (let g of l.querySelectorAll("[data-fancybox-prev]"))
                a.page > 0
                  ? (g.removeAttribute(Bt), g.removeAttribute(ht))
                  : (g.setAttribute(Bt, ""), g.setAttribute(ht, "-1"));
            }
            ...
            if (!c) return;
            let u = c.downloadSrc || "";
            u || c.type !== "image" || c.error || !ct(c[Ft]) || (u = c[Ft]);
            for (let g of l.querySelectorAll("[data-fancybox-download]")) {
              let s = c.downloadFilename;
              u
                ? (g.removeAttribute(Bt),
                  g.removeAttribute(ht),
                  g.setAttribute(xn, u),
                  g.setAttribute(Yi, s || u),
                  g.setAttribute("target", "_blank"))
                : (g.setAttribute(Bt, ""), g.setAttribute(ht, "-1"), g.removeAttribute(xn), g.removeAttribute(Yi));
            }
          }),
      ...
      onClick(t) {
        ...
        if (a.closest(".fancybox-spinner") || a.closest("[data-fancybox-close]"))
        ...
        if ((t.type === "click" && t.detail === 0) || Math.abs(t.pageX - Vi) > 30 || Math.abs(t.pageY - ki) > 30)
          return;
        let l = document.activeElement;
        if (ji() && l && n.contains(l)) return;
      ...
      onWheel(t) {
        ...
        let i = n === "slide",
          a = [-t.deltaX || 0, -t.deltaY || 0, -t.detail || 0].reduce(function (u, g) {
            return Math.abs(g) > Math.abs(u) ? g : u;
          }),
        ...
        this.pwt && c - this.pwt < 300
          ...
          : ((this.pwt = c),
            ...
            t.defaultPrevented ||
              (n === "close"
                ? (t.preventDefault(), this.close(t))
                : n === "slide" && (fe(e) || (t.preventDefault(), this[l > 0 ? "prev" : "next"]()))));
      }
      onScroll() {
        window.scrollTo(Si, Ri);
      }
      onKeydown(t) {
        ...
        if (
          (e !== "Escape" &&
            !l &&
            k(i) &&
            (i.isContentEditable || ["TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].indexOf(i.nodeName) !== -1)) ||
          (t.key === "Tab" ? U(this.container, yn) : M(this.container, yn), t.ctrlKey || t.altKey || t.shiftKey)
        )
          return;
      ...
      manageCloseBtn(t) {
        ...
        if (e === "auto") {
          ...
          if (i && i.state === mt.Ready) return;
        }
        if (!e || !t.contentEl || t.closeBtnEl) return;
        let n = this.option("tpl.closeButton");
        if (n) {
          let i = et(this.localize(n));
          ((t.closeBtnEl = t.contentEl.appendChild(i)), t.el && U(t.el, "has-close-btn"));
        }
      }
      manageCaption(t = void 0) {
        ...
        if (c) {
          ...
          ((s = this.caption),
            s || (s = a.querySelector("." + i)),
            !s &&
              ((s = document.createElement("div")),
              (s.dataset.fancyboxCaption = ""),
              U(s, i),
              (this.footer || a).prepend(s)),
            U(a, Qe),
            (this.caption = s));
        s &&
          ((s.innerHTML = ""),
          ct(g) || typeof g == "number" ? (s.innerHTML = g + "") : g instanceof HTMLElement && s.appendChild(g));
      }
      checkFocus(t) {
        this.focus(t);
      }
      focus(t) {
        ...
        let c = this.getSlide(),
          u = c && c.state === V.Ready ? c.el : null;
        if (!u || u.contains(n) || a === n) return;
        (t && t.cancelable && t.preventDefault(), (this.ignoreFocusChange = !0));
        let g = Array.from(a.querySelectorAll(pn)),
          s = [],
          r = null;
        for (let h of g) {
          ...
          if (h === a || ((m || p) && !b)) {
            s.push(h);
            let Q = h.dataset.origTabindex;
            (Q !== void 0 && Q && (h.tabIndex = parseFloat(Q)),
              h.removeAttribute("data-orig-tabindex"),
              (!h.hasAttribute("autoFocus") && r) || (r = h));
          } else {
            let Q = h.dataset.origTabindex === void 0 ? h.getAttribute("tabindex") || "" : h.dataset.origTabindex;
            (Q && (h.dataset.origTabindex = Q), (h.tabIndex = -1));
          }
        }
        let d = null;
        (t
          ? (!i || s.indexOf(i) < 0) &&
            ((d = r || a),
            s.length && (n === gt ? (d = s[0]) : (this.lastFocus !== a && n !== K) || (d = s[s.length - 1])))
          : (d = c && c.type === "image" ? a : r || a),
          d && Ci(d),
      ...
      animate(t = null, e = "", n) {
        ...
        let i = (a) => {
          a.target === t &&
            ...
            (t.removeEventListener("animationend", i), delete t.dataset.animationName, n && n(), M(t, e));
        };
        ((t.dataset.animationName = e), t.addEventListener("animationend", i), U(t, e));
      }
      stop(t) {
      ...
      revealContent(t, e) {
        ...
        this.isClosing() ||
          ...
          this.isOpeningSlide(t) && (M(this.container, Cn), !this.isCompact && this.option("idle") && this.setIdle()));
      }
      isCurrentSlide(t) {
        let e = this.getSlide();
          ...
          t.spinnerEl ||
            setTimeout(() => {
              if (!this.isClosing() && !t.spinnerEl && t.state === V.Loading) {
                let n = et(On);
                (U(n, "fancybox-spinner"), (t.spinnerEl = n), e.prepend(n), this.animate(n, "f-fadeIn"));
              }
            }, 250));
      }
      hideLoading(t) {
      ...
      setError(t, e) {
        if (this.isClosing()) return;
        let n = new Event("error", { bubbles: !0, cancelable: !0 });
      ...
      clearContent(t) {
        ...
        let e = t.el;
        (e && (M(e, "has-error"), M(e, "has-unknown"), M(e, `has-${t.type || "unknown"}`)),
      ...
      close(t, e) {
        if (this.isClosing()) return;
        let n = new Event("shouldClose", { bubbles: !0, cancelable: !0 });
        if ((this.emit("shouldClose", n, t), n.defaultPrevented)) return;
        t && t.cancelable && (t.preventDefault(), t.stopPropagation());
        let i = () => {
          this.proceedClose(t, e);
        };
        this.startedFs && H && H.isFullscreen() ? Promise.resolve(H.exit()).then(() => i()) : i();
      }
      clearIdle() {
      ...
      setIdle(t = !1) {
        let e = () => {
          (this.clearIdle(), (this.idle = !0), U(this.container, "is-idle"), this.emit("setIdle"));
        };
      ...
      endIdle() {
        (this.clearIdle(),
          this.idle && !this.isClosing() && ((this.idle = !1), M(this.container, "is-idle"), this.emit("endIdle")));
      }
      resetIdle() {
      ...
      proceedClose(t, e) {
        ...
        if (
          ...
          a &&
            (M(a, Cn),
            U(a, "is-closing"),
            a.setAttribute(Un, "true"),
            this.option("animated") && U(a, In),
          ...
          for (let g of l.slides) {
            ((g.state = V.Closing), this.hideLoading(g));
            let s = g.contentEl;
            s && this.stop(s);
            let r = g?.panzoom;
            (r && (r.stop(), r.detachEvents(), r.detachObserver()), this.isCurrentSlide(g) || l.emit("removeSlide", g));
          }
        }
        ((Si = window.scrollX),
          (Ri = window.scrollY),
      ...
      destroy() {
        ...
        let e = this.container;
        (e && e.remove(), vt.delete(this.id));
        let n = o.getInstance();
        n
          ? n.focus()
          : (K && (K.remove(), (K = null)),
            gt && (gt.remove(), (gt = null)),
            M(document.documentElement, Di),
            (() => {
              if (!Gt) return;
              let i = document,
                a = i.body;
              (a.classList.remove(vn), a.style.setProperty(Xi, ""), i.documentElement.style.setProperty(Zi, ""));
            })(),
            this.emit("destroy"));
      }
      static bind(t, e, n) {
        ...
        if (
          (t === void 0
            ? (i = document.body)
            : ct(t)
              ? ((i = document.body), (a = t), typeof e == "object" && (l = e || {}))
              : ((i = t), ct(e) && (a = e), typeof n == "object" && (l = n || {})),
          !i || !k(i))
        )
          return;
        a = a || "[data-fancybox]";
      ...
      static fromEvent(t) {
        ...
        if (n) {
          let b = n.dataset.fancyboxTrigger || "",
            m = document.querySelectorAll(`[data-fancybox="${b}"]`),
            p = parseInt(n.dataset.fancyboxIndex || "", 10) || 0;
          e = m[p] || e;
        }
        ...
        let u = [],
          g = S({}, Wn, c);
        ((g.event = t), (g.triggerEl = e), (g.delegate = n));
        let s = g.groupAll,
          r = g.groupAttr,
          d = r && e ? e.getAttribute(`${r}`) : "";
        if (
          ((!e || d || s) && (u = [].slice.call(i.querySelectorAll(a))),
          e && !s && (u = d ? u.filter((b) => b.getAttribute(`${r}`) === d) : [e]),
          !u.length)
        )
          return;
        let h = o.getInstance();
        return h && h.options.triggerEl && u.indexOf(h.options.triggerEl) > -1
          ? void 0
          : (e && (g.startIndex = u.indexOf(e)), o.fromNodes(u, g));
      }
      static fromSelector(t, e, n) {
        ...
        if (
          (ct(t)
            ? ((i = document.body), (a = t), typeof e == "object" && (l = e || {}))
            : t instanceof HTMLElement && ct(e) && ((i = t), (a = e), typeof n == "object" && (l = n || {})),
          !i || !a)
        )
          return !1;
        let c = o.openers.get(i);
        return !!c && ((l = S({}, c.get(a) || {}, l)), !!l && o.fromNodes(Array.from(i.querySelectorAll(a)), l));
      }
      static fromNodes(t, e) {
        ...
        for (let i of t) {
          let a = i.dataset || {},
            l = a[Ft] || i.getAttribute(xn) || i.getAttribute("currentSrc") || i.getAttribute(Ft) || void 0,
            c,
            u = e.delegate,
            g;
          (u &&
            n.length === e.startIndex &&
            (c = u instanceof HTMLImageElement ? u : u.querySelector("img:not([aria-hidden])")),
            c || (c = i instanceof HTMLImageElement ? i : i.querySelector("img:not([aria-hidden])")),
            c &&
              ((g = c.currentSrc || c[Ft] || void 0),
              !g && c.dataset && (g = c.dataset.lazySrc || c.dataset[Ft] || void 0)));
          let s = { src: l, triggerEl: i, thumbEl: c, thumbElSrc: g, thumbSrc: g };
          for (let r in a) {
            let d = a[r] + "";
      ...
      static close(t = !0, ...e) {
        if (t) for (let n of vt.values()) n.close(...e);
        else {
          let n = o.getInstance();
          n && n.close(...e);
        }
  ...
  (Object.defineProperty(P, "version", { enumerable: !0, configurable: !0, writable: !0, value: "5.0.36" }),
    Object.defineProperty(P, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: Wn }),
    Object.defineProperty(P, "Plugins", { enumerable: !0, configurable: !0, writable: !0, value: ws }),
    Object.defineProperty(P, "openers", { enumerable: !0, configurable: !0, writable: !0, value: new Map() }));
  ...
  ((Gn.targets = ["dialog"]), (Gn.values = { open: { type: Boolean, default: !1 } }));
  var to = Gn;
  var Dn = {};
  R(Dn, { default: () => Zt });
  var Zt = class extends A {
    ...
    updateVolume(o) {
      o.target.muted
        ? ((this.mutedValue = !0), (this.volumeValue = 0))
        : ((this.mutedValue = !1), (this.volumeValue = o.target.volume));
  ...
  var Ae = class extends A {
    connect() {
      let o = Math.floor(Math.random() * 4) + 8;
      (this.generateStars(o, "left"),
        this.generateStars(o, "right"),
        setTimeout(function () {
          document.getElementById("ch5_cover").classList.add("!hidden");
        }, 3500));
    }
    generateStars(o, t) {
      for (let e = 0; e < o; e++) {
        let n = Math.floor(Math.random() * 30) + 10,
          i = Math.floor(Math.random() * 15) + 10 + e * 10;
        this.appendStar(n, i, t);
      }
    }
    appendStar(o, t, e) {
      let n = Math.floor(Math.random() * 7) + 1,
        i = Math.floor(Math.random() * 12) / 3,
        a = document.createElement("img");
      (a.setAttribute("class", "absolute image-pixel animate-ch5-star md:scale-125 lg:scale-150"),
        a.setAttribute("src", `/assets/images/ch5-star-${n}.png`),
        a.setAttribute("alt", "Star"),
        a.setAttribute("aria-hidden", "true"),
        a.setAttribute("style", `top: ${t}%; right: ${o}%; animation-delay: -${i}s`),
        e == "left" ? this.containerLeftTarget.append(a) : this.containerRightTarget.append(a));
    }
    skipIntro() {
      this.coverTarget.classList.add("!hidden");
      for (let o of document.querySelectorAll(".skippable")) o.setAttribute("style", "animation-delay: 0s");
    }
  };
  W(Ae, "targets", ["star", "containerLeft", "containerRight", "cover"]);
  var Sn = {};
  R(Sn, { default: () => Vt });
  var Xn = typeof navigator < "u" ? navigator.userAgent.toLowerCase().indexOf("firefox") > 0 : !1;
  function En(o, t, e, n) {
    o.addEventListener ? o.addEventListener(t, e, n) : o.attachEvent && o.attachEvent(`on${t}`, e);
  }
  function Xt(o, t, e, n) {
    o && (o.removeEventListener ? o.removeEventListener(t, e, n) : o.detachEvent && o.detachEvent(`on${t}`, e));
  }
  function io(o, t) {
    let e = t.slice(0, t.length - 1),
      n = [];
    for (let i = 0; i < e.length; i++) n.push(o[e[i].toLowerCase()]);
    return n;
  }
  function oo(o) {
  ...
  function so(o) {
    ...
    return o.key && /^[a-z]$/i.test(o.key)
      ? o.key.toUpperCase().charCodeAt(0)
      : (o.code && /^Key[A-Z]$/.test(o.code) && (t = o.code.charCodeAt(3)), t);
  }
  var Yt = {
      backspace: 8,
      "\u232B": 8,
    ...
    Z = {};
  for (let o = 1; o < 20; o++) Yt[`f${o}`] = 111 + o;
  var D = [],
    Nt = null,
    It = null,
    ao = "all",
    rt = new Map(),
    Ct = (o) => Yt[o.toLowerCase()] || q[o.toLowerCase()] || o.toUpperCase().charCodeAt(0),
    Ws = (o) => Object.keys(Yt).find((t) => Yt[t] === o),
    Ms = (o) => Object.keys(q).find((t) => q[t] === o),
    ro = (o) => {
      ao = o || "all";
    },
    jt = () => ao || "all",
    Os = () => D.slice(0),
    Gs = () => D.map((o) => Ws(o) || Ms(o) || String.fromCharCode(o)),
    Ds = () => {
      let o = [];
      return (
        Object.keys(Z).forEach((t) => {
          Z[t].forEach(({ key: e, scope: n, mods: i, shortcut: a }) => {
            o.push({ scope: n, shortcut: a, mods: i, keys: e.split("+").map((l) => Ct(l)) });
          });
        }),
        o
      );
    ...
    Zs = (o) => (typeof o == "string" && (o = Ct(o)), D.indexOf(o) !== -1),
    Xs = (o, t) => {
      let e, n;
      o || (o = jt());
      for (let i in Z)
        if (Object.prototype.hasOwnProperty.call(Z, i))
          for (e = Z[i], n = 0; n < e.length; )
            e[n].scope === o ? e.splice(n, 1).forEach(({ element: l }) => Yn(l)) : n++;
      jt() === o && ro(t || "all");
    };
  function Es(o) {
    let t = so(o);
    o.key && o.key.toLowerCase() === "capslock" && (t = Ct(o.key));
    let e = D.indexOf(t);
    if (
      (e >= 0 && D.splice(e, 1),
      o.key && o.key.toLowerCase() === "meta" && D.splice(0, D.length),
      (t === 93 || t === 224) && (t = 91),
      t in Y)
    ) {
      Y[t] = !1;
      for (let n in q) q[n] === t && ($[n] = !1);
    }
  }
  var co = (o, ...t) => {
      if (typeof o > "u")
        (Object.keys(Z).forEach((e) => {
          (Array.isArray(Z[e]) && Z[e].forEach((n) => We(n)), delete Z[e]);
        }),
          Yn(null));
        ...
        let [e, n] = t;
        (typeof e == "function" && ((n = e), (e = "")), We({ key: o, scope: e, method: n, splitKey: "+" }));
      }
    },
    We = ({ key: o, scope: t, method: e, splitKey: n = "+" }) => {
      oo(o).forEach((a) => {
        let l = a.split(n),
          c = l.length,
          u = l[c - 1],
        ...
        let s = c > 1 ? io(q, l) : [],
          r = [];
        ((Z[g] = Z[g].filter((d) => {
          let b = (e ? d.method === e : !0) && d.scope === t && As(d.mods, s);
          return (b && r.push(d.element), !b);
        })),
          r.forEach((d) => Yn(d)));
      });
    };
    ...
    if (t.scope === e || t.scope === "all") {
      ...
      for (let a in Y)
        Object.prototype.hasOwnProperty.call(Y, a) &&
          ((!Y[a] && t.mods.indexOf(+a) > -1) || (Y[a] && t.mods.indexOf(+a) === -1)) &&
          (i = !1);
      ((t.mods.length === 0 && !Y[16] && !Y[18] && !Y[17] && !Y[91]) || i || t.shortcut === "*") &&
        ((t.keys = []),
        (t.keys = t.keys.concat(D)),
        t.method(o, t) === !1 &&
          (o.preventDefault ? o.preventDefault() : (o.returnValue = !1),
          o.stopPropagation && o.stopPropagation(),
          o.cancelBubble && (o.cancelBubble = !0)));
    }
  }
  function no(o, t) {
    let e = Z["*"],
      n = so(o);
    if ((o.key && o.key.toLowerCase() === "capslock") || !($.filter || lo).call(this, o)) return;
    if (
      ((n === 93 || n === 224) && (n = 91),
      D.indexOf(n) === -1 && n !== 229 && D.push(n),
      ["metaKey", "ctrlKey", "altKey", "shiftKey"].forEach((u) => {
        let g = Et[u];
        o[u] && D.indexOf(g) === -1
          ? D.push(g)
          : !o[u] && D.indexOf(g) > -1
            ? D.splice(D.indexOf(g), 1)
            : u === "metaKey" && o[u] && (D = D.filter((s) => s in Et || s === n));
      }),
      n in Y)
    ) {
      Y[n] = !0;
    ...
    for (let u in Y) Object.prototype.hasOwnProperty.call(Y, u) && (Y[u] = o[Et[u]]);
    o.getModifierState &&
      !(o.altKey && !o.ctrlKey) &&
      o.getModifierState("AltGraph") &&
      (D.indexOf(17) === -1 && D.push(17), D.indexOf(18) === -1 && D.push(18), (Y[17] = !0), (Y[18] = !0));
    let a = jt();
    if (e)
      for (let u = 0; u < e.length; u++)
        e[u].scope === a &&
          ((o.type === "keydown" && e[u].keydown) || (o.type === "keyup" && e[u].keyup)) &&
          eo(o, e[u], a, t);
    if (!(n in Z)) return;
    let l = Z[n],
      c = l.length;
    for (let u = 0; u < c; u++)
      if (((o.type === "keydown" && l[u].keydown) || (o.type === "keyup" && l[u].keyup)) && l[u].key) {
        let g = l[u],
          { splitKey: s } = g,
          r = g.key.split(s),
          d = [];
        for (let h = 0; h < r.length; h++) d.push(Ct(r[h]));
        d.sort().join("") === D.sort().join("") && eo(o, g, a, t);
      }
  }
  var $ = function o(t, e, n) {
    D = [];
    let i = oo(t),
      a = [],
      l = "all",
      ...
      d = !1,
      h = !1;
    if ((n === void 0 && typeof e == "function" && (n = e), Object.prototype.toString.call(e) === "[object Object]")) {
      let b = e;
      (b.scope && (l = b.scope),
        b.element && (c = b.element),
        b.keyup && (g = b.keyup),
        b.keydown !== void 0 && (s = b.keydown),
        b.capture !== void 0 && (d = b.capture),
        typeof b.splitKey == "string" && (r = b.splitKey),
        b.single === !0 && (h = !0));
    }
    for (typeof e == "string" && (l = e), h && co(t, l); u < i.length; u++) {
      let b = i[u].split(r);
      ((a = []), b.length > 1 && (a = io(q, b)));
      let m = b[b.length - 1];
      ((m = m === "*" ? "*" : Ct(m)),
        m in Z || (Z[m] = []),
        Z[m].push({
    ...
    if (typeof c < "u" && typeof window < "u") {
      if (!rt.has(c)) {
        let b = (p = window.event) => no(p, c),
          m = (p = window.event) => {
            (no(p, c), Es(p));
          };
        (rt.set(c, { keydownListener: b, keyupListenr: m, capture: d }), En(c, "keydown", b, d), En(c, "keyup", m, d));
      }
      if (!Nt) {
        let b = () => {
          D = [];
        };
        ((Nt = { listener: b, capture: d }), En(window, "focus", b, d));
      }
      if (!It && typeof document < "u") {
        let b = () => {
            D = [];
            for (let Q in Y) Y[Q] = !1;
            for (let Q in q) o[Q] = !1;
          },
          m = b,
          p = b;
        (document.addEventListener("fullscreenchange", m),
          document.addEventListener("webkitfullscreenchange", p),
          (It = { fullscreen: m, webkit: p }));
      }
    }
  };
  function Ns(o, t = "all") {
  ...
  function Yn(o) {
    ...
    if (t.findIndex(({ element: n }) => n === o) < 0 && o) {
      let { keydownListener: n, keyupListenr: i, capture: a } = rt.get(o) || {};
      n && i && (Xt(o, "keyup", i, a), Xt(o, "keydown", n, a), rt.delete(o));
    }
    if (t.length <= 0 || rt.size <= 0) {
      if (
        (Array.from(rt.keys()).forEach((i) => {
          let { keydownListener: a, keyupListenr: l, capture: c } = rt.get(i) || {};
          a && l && (Xt(i, "keyup", l, c), Xt(i, "keydown", a, c), rt.delete(i));
        }),
        rt.clear(),
        Object.keys(Z).forEach((i) => delete Z[i]),
        Nt)
      ) {
        let { listener: i, capture: a } = Nt;
        (Xt(window, "focus", i, a), (Nt = null));
      }
      It &&
        typeof document < "u" &&
        (document.removeEventListener("fullscreenchange", It.fullscreen),
        document.removeEventListener("webkitfullscreenchange", It.webkit),
        (It = null));
    }
  }
  var Nn = {
    getPressedKeyString: Gs,
    setScope: ro,
    getScope: jt,
    deleteScope: Xs,
    getPressedKeyCodes: Os,
    getAllKeyCodes: Ds,
    isPressed: Zs,
    filter: lo,
    trigger: Ns,
  ...
  for (let o in Nn) {
    let t = o;
    Object.prototype.hasOwnProperty.call(Nn, t) && ($[t] = Nn[t]);
  }
  if (typeof window < "u") {
  ...
  var jn = { debug: !1, logger: console, dispatchEvent: !0, eventPrefix: !0 },
    Vn = class {
      constructor(t, e = {}) {
        var n, i, a;
        ((this.log = (u, g) => {
          this.debug &&
            (this.logger.groupCollapsed(`%c${this.controller.identifier} %c#${u}`, "color: #3B82F6", "color: unset"),
            this.logger.log(Object.assign({ controllerId: this.controllerId }, g)),
            this.logger.groupEnd());
        }),
          (this.warn = (u) => {
            this.logger.warn(
              `%c${this.controller.identifier} %c${u}`,
          ...
          (this.dispatch = (u, g = {}) => {
            if (this.dispatchEvent) {
              let { event: s } = g,
                r = Ys(g, ["event"]),
                d = this.extendedEvent(u, s || null, r);
              (this.targetElement.dispatchEvent(d), this.log("dispatchEvent", Object.assign({ eventName: d.type }, r)));
            }
          }),
          (this.call = (u, g = {}) => {
            let s = this.controller[u];
            if (typeof s == "function") return s.call(this.controller, g);
          }),
          (this.extendedEvent = (u, g, s) => {
            let { bubbles: r, cancelable: d, composed: h } = g || { bubbles: !0, cancelable: !0, composed: !0 };
            return (
              g && Object.assign(s, { originalEvent: g }),
          ...
          (this.composeEventName = (u) => {
            ...
            return (
              this.eventPrefix === !0
                ? (g = `${this.controller.identifier}:${u}`)
                : typeof this.eventPrefix == "string" && (g = `${this.eventPrefix}:${u}`),
              g
            );
          }),
          (this.debug =
            (i = (n = e?.debug) !== null && n !== void 0 ? n : t.application.stimulusUseDebug) !== null && i !== void 0
              ? i
              : jn.debug),
          (this.logger = (a = e?.logger) !== null && a !== void 0 ? a : jn.logger),
          (this.controller = t),
          (this.controllerId = t.element.id || t.element.dataset.id),
          (this.targetElement = e?.element || t.element));
        let { dispatchEvent: l, eventPrefix: c } = Object.assign({}, jn, e);
    ...
    js = (o) => ({ handler: o[0], options: { element: o[1] } }),
    Vs = (o) => {
      if (!o.hotkeys) {
        let t = {};
        (Object.entries(o).forEach(([e, n]) => {
          Object.defineProperty(t, e, { value: js(n), writable: !1, enumerable: !0 });
        }),
          (o = { hotkeys: t }));
      }
      return o;
    },
    uo = (o, t) => new kn(o, Vs(t));
  var Vt = class extends A {
    connect() {
      ((this.butTarget.style.left = "120%"),
        uo(this, { hotkeys: { left: { handler: this.startMove, options: { keydown: !0, keyup: !0 } } } }),
  ...
  (W(Vt, "targets", ["but"]), W(Vt, "values", { moving: { type: Boolean, default: !1 } }));
  var Rn = {};
  R(Rn, { default: () => kt });
  var kt = class extends A {
    ...
    updateCountdown() {
      ...
      if (
        (c < 10 && (c = `0${c}`),
        i == 0 ? (a == 0 ? (e = " scale-[1.5]") : (e = " scale-[1.3]")) : i <= 3 && (e = " scale-[1.1]"),
        !this.endedValue)
      )
        if (n < 0) {
          let u = document.getElementById("game");
          (u.classList.add("motion-safe:opacity-0", "motion-safe:animate-fade-in"),
            u.setAttribute("style", "animation-delay: 3.5s"),
            document.getElementById("ch5_countdown").replaceWith(document.getElementById("game")),
            (this.endedValue = !0));
        } else {
          if (this.localeValue == "ja_JP") {
            let u = this.timeValue.substring(8, 10);
            this.dateTarget.innerHTML = `${this.timeValue.substring(0, 4)}\u5E74${this.timeValue.substring(6, 7)}\u6708${parseInt(u) + 1}\u65E5\u3000\u30EA\u30EA\u30FC\u30B9`;
          } else {
            let u = [
                "January",
                "February",
              ...
              g = this.timeValue.substring(8, 10);
            ((this.dateTarget.innerHTML = `Releasing on <br class='inline md:hidden' />${u[t.getMonth()]} ${g}, ${this.timeValue.substring(0, 4)}`),
              (this.infoTarget.innerHTML = `* ${u[t.getMonth()]} ${parseInt(g) + 1} in Japan, <br class='inline md:hidden' />Australia, and New Zealand`));
          }
          this.countdownTarget.innerHTML = `<div class='flex gap-x-2 items-center justify-center${e}'>${i > 0 ? "<span class='text-xl whitespace-nowrap md:text-6xl min-w-[32px] md:min-w-[86px] text-right'>" + i + "</span><span class='text-lg md:text-5xl w-2 md:w-8'>:</span>" : ""}${i > 0 || a > 0 ? "<span class='text-xl whitespace-nowrap md:text-6xl min-w-[32px] md:min-w-[86px] text-right'>" + a + "</span><span class='text-lg md:text-5xl w-2 md:w-8'>:</span>" : ""}<span class='text-xl whitespace-nowrap md:text-6xl min-w-[32px] md:min-w-[86px] text-right'>${l}</span><span class='text-lg md:text-5xl w-2 md:w-8'>:</span><span class='text-xl whitespace-nowrap md:text-6xl min-w-[32px] md:min-w-[86px] text-right'>${c}</span></div>`;
        }
    }
    getLatestCountdown() {
      fetch(this.sourceValue, { cache: "no-store" })
        ...
        .catch((o) => {
          ((this.timeValue = "2026-06-24T11:00:00-04:00"), this.startCountdown());
        });
    }
    startCountdown() {
      (this.updateCountdown(),
        !this.startedValue &&
          !this.endedValue &&
          (setInterval(this.updateCountdown.bind(this), 1e3), (this.startedValue = !0)));
    }
  };
  (W(kt, "targets", ["date", "countdown", "info"]),
    W(kt, "values", {
  ...
  var Me = class extends A {
    ...
    appendParticle(o, t, e, n = 12) {
      ...
      (c.setAttribute("class", "absolute opacity-50 animate-pulse motion-safe:translate-y-0"),
        ...
        c.setAttribute("style", `margin-left: ${o}px; margin-top: ${t}px; animation-delay: -${a}s; max-width: ${n}px`),
    ...
    appendPixel(o, t, e, n = 4) {
      ...
      (u.setAttribute("class", "absolute animate-pulse motion-safe:translate-y-0 border-0"),
        u.setAttribute("data-distance", l),
        u.setAttribute("data-scroll-target", "parallax"),
        u.setAttribute(
          "style",
  ...
  W(Me, "targets", ["particle", "container", "mobile"]);
  var zn = {};
  R(zn, { default: () => Rt });
  var St = $t(Ge(), 1);
  var Rt = class extends A {
    connect() {
      let o = new St.Howl({ src: ["/assets/audio/sprinkle.ogg", "/assets/audio/sprinkle.mp3"], volume: 0.5 });
      this.sprinkle = o;
      let t = new St.Howl({
      ...
      this.susie = e;
      let n = new St.Howl({ src: ["/assets/audio/face.ogg", "/assets/audio/face.mp3"], volume: 0.5 });
      ((this.face = n),
    ...
    clickCat(o) {
      this.catTarget.classList.contains("animate-caught") == !1 &&
        ((this.pullsValue += 1),
    ...
    pointsValueChanged(o, t) {
      if (
        ...
        this.initializedValue == !0 && (localStorage.setItem("rarecats-points", this.pointsValue), o > t))
      ) {
        let e = o - t,
  ...
  (W(Rt, "targets", ["cat", "container", "window"]),
    W(Rt, "values", {
  ...
  var Tt = class extends A {
    connect() {
      ...
      let o = new _n.Howl({ src: ["/assets/audio/slam.ogg", "/assets/audio/slam.mp3"], volume: 0.5 });
      this.slam = o;
      let t = new _n.Howl({ src: ["/assets/audio/ma.ogg", "/assets/audio/ma.mp3"], volume: 0.5 });
      this.ma = t;
    }
    start() {
      this.startedValue == !1 &&
  ...
  (W(Tt, "targets", ["container", "door", "square", "escaped"]),
    W(Tt, "values", {
      clicked: { type: Boolean, default: !1 },
      escaped: { type: Boolean, default: !1 },
      started: { type: Boolean, default: !1 },
  ...
  var De = class extends A {
    connect() {
      let o = new ho.Howl({ src: ["/assets/audio/chord.ogg", "/assets/audio/chord.mp3"], volume: 0.5 });
      this.sound = o;
    }
    click(o) {
      this.clicksValue >= 3
  ...
  W(De, "values", { clicks: { type: Number, default: 0 } });
  var Pn = {};
  R(Pn, { default: () => Xe });
  var Ze = $t(bo(), 1);
  ...
  W(Xe, "targets", ["parallax", "parafade"]);
  var $n = {};
  R($n, { default: () => Ee });
  var Ee = class extends A {
    connect() {
      (this.appendStar(Math.floor(Math.random() * 10) + 450, Math.floor(Math.random() * 10) + 100, !1),
        this.appendStar(Math.floor(Math.random() * 10) + 320, Math.floor(Math.random() * 5) + 105, !1),
        this.appendStar(Math.floor(Math.random() * 10) + 480, Math.floor(Math.random() * 10) + 150, !1),
        this.appendStar(Math.floor(Math.random() * 10) + 500, Math.floor(Math.random() * 10) + 350, !1),
        this.appendStar(0 - (Math.floor(Math.random() * 10) + 450), Math.floor(Math.random() * 10) + 100, !1),
        this.appendStar(0 - (Math.floor(Math.random() * 10) + 320), Math.floor(Math.random() * 5) + 105, !1),
        this.appendStar(0 - (Math.floor(Math.random() * 10) + 480), Math.floor(Math.random() * 10) + 150, !1),
        this.appendStar(0 - (Math.floor(Math.random() * 10) + 500), Math.floor(Math.random() * 10) + 325, !1));
    ...
    appendStar(o, t, e) {
      ...
      (l.setAttribute("class", "absolute opacity-50 animate-pulse image-pixel motion-safe:translate-y-0"),
  ...
  W(Ee, "targets", ["star", "container"]);
  var qn = {};
  R(qn, { default: () => zt });
  var zt = class extends A {
    connect() {
      ((this.locale = {
        en: { unknown: "Unknown contact.", error: "She never smiled?", thank_you: "Thank you." },
        ja: {
          unknown: "\u4E0D\u660E\u306E\u9023\u7D61\u5148",
          error: "\u5F7C\u5973\u306F\u4E8C\u5EA6\u3068\u7B11\u308F\u306A\u304B\u3063\u305F\uFF1F",
          thank_you: "\u3042\u308A\u304C\u3068\u3046\u3002",
  ...
  (W(zt, "targets", ["button", "form", "feedback", "field"]),
    W(zt, "values", { locale: { type: String, default: "en" } }));
  var ti = {};
  R(ti, { default: () => _t });
  var _t = class extends A {
    ...
    draw(o) {
      if (this.drawingValue) {
        ...
        if (
          (e.classList.add("absolute", "w-[8px]", "h-[8px]", "bg-white", "pointer-events-none", "select-none"),
        ...
        ((this.dotsDrawnValue += 1),
          this.revealingValue == !1 &&
            this.dotsDrawnValue > 2500 &&
            ((this.revealingValue = !0),
  ...
  (W(_t, "targets", ["container", "coverbox", "cover", "dot", "tree"]),
    W(_t, "values", {
      drawing: { type: Boolean, default: !1 },
      dotsDrawn: { type: Number, default: 0 },
      revealing: { type: Boolean, default: !1 },
    }));
  var ei = {};
  R(ei, { default: () => Ne });
  var Ne = class extends A {
    ...
    playVideo(o) {
      this.hasVideoTarget &&
        ...
        this.videoTarget.setAttribute("controls", !0),
    ...
    playExternalVideo(o) {
      this.hasContainerTarget &&
        (o.preventDefault(),
        (this.containerTarget.innerHTML = `<iframe class="w-full aspect-video" src="https://www.youtube-nocookie.com/embed/${o.params.ytid}?autoplay=1" credentialless allowfullscreen referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin" csp="sandbox allow-scripts allow-same-origin;" frameborder="0" allow="accelerometer 'none'; ambient-light-sensor 'none'; autoplay 'none'; battery 'none'; browsing-topics 'none'; camera 'none'; display-capture 'none'; domain-agent 'none'; document-domain 'none'; encrypted-media 'none'; execution-while-not-rendered 'none'; execution-while-out-of-viewport ''; gamepad 'none'; geolocation 'none'; gyroscope 'none'; hid 'none'; identity-credentials-get 'none'; idle-detection 'none'; local-fonts 'none'; magnetometer 'none'; microphone 'none'; midi 'none'; otp-credentials 'none'; payment 'none'; picture-in-picture 'none'; publickey-credentials-create 'none'; publickey-credentials-get 'none'; screen-wake-lock 'none'; serial 'none'; speaker-selection 'none'; usb 'none'; window-management 'none'; xr-spatial-tracking 'none'"></iframe>`));
    }
  };
  W(Ne, "targets", ["container", "playButton", "video"]);
  var ks = {
      "./controllers/audio_controller.js": Dn,
      "./controllers/ch5stars_controller.js": Zn,
      "./controllers/chapter3_controller.js": Sn,
      "./controllers/countdown_controller.js": Rn,
      "./controllers/particles_controller.js": Tn,
      "./controllers/rarecats_controller.js": zn,
      "./controllers/romb_controller.js": Jn,
      "./controllers/roots_controller.js": Hn,
      "./controllers/scroll_controller.js": Pn,
      "./controllers/stars_controller.js": $n,
      "./controllers/thankyou_controller.js": qn,
      "./controllers/therapy_controller.js": ti,
      "./controllers/video_controller.js": ei,
    },
    mo = ks;
  P.bind("[data-fancybox]", {
    Toolbar: { display: { left: [], middle: [], right: ["close"] } },
    Thumbs: { type: "classic" },
    Hash: !1,
  });
  window.Stimulus = oe.start();
  Stimulus.register("dialog", to);
  Object.entries(mo).forEach(([o, t]) => {
