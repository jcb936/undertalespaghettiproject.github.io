...
function createOrUpdateMarquee() {
  ...
  if (marquee.length > 0) {
    ...
    $("#marquee_container").append("<div class='text-center d-block yellow w-100 pt-1' style='font-size: 25px'><marquee behavior=scroll >ADATTAMENTO DELL'EVENTO $PAMTON $WEEPSTAKES; ORIGINARIAMENTE CREATO DA FANGAMER. È FINITO!!!!!</div>");
  }
}
